;(function () {
  ...
  ;(function () {
    ...
    ;('use strict')
    function _0x559ec2() {
      if (Lampa.Manifest.origin !== 'PersonalHub') {
        var _0x175cd0 = function (_0x2d965e) {
            var _0x287088 = _0x2d965e.card || _0x2d965e,
              _0x17f5e9 =
                _0x2d965e.next_episode_to_air || _0x2d965e.episode || {}
            ...
            this.build = function () {
              ...
              this.card.querySelector('.card__title').innerText =
                _0x287088.title
          ...
          _0x35171b = function (_0x2719a3) {
            ...
            this.main = function () {
                ...
                _0x31a0df = [
                  {
                    id: 'now_watch',
                    order:
                      parseInt(Lampa.Storage.get('number_now_watch'), 10) || 1,
                  ...
                  },
                  {
                    id: 'trend_day',
                    order:
                      parseInt(Lampa.Storage.get('number_trend_day'), 10) || 3,
                    active: !Lampa.Storage.get('trend_day_remove'),
                  },
                  {
                    id: 'trend_day_tv',
                    order:
                      parseInt(Lampa.Storage.get('number_trend_day_tv'), 10) ||
                      4,
                  ...
                  },
                  {
                    ...
                    order:
                      parseInt(
                        Lampa.Storage.get('number_trend_day_film'),
                        10
                      ) || 5,
                  ...
                  },
                  {
                    id: 'trend_week',
                    order:
                      parseInt(Lampa.Storage.get('number_trend_week'), 10) || 6,
                    active: !Lampa.Storage.get('trend_week_remove'),
                  },
                  {
                    id: 'trend_week_tv',
                    order:
                      parseInt(Lampa.Storage.get('number_trend_week_tv'), 10) ||
                      7,
                  ...
                  },
                  {
                    ...
                    order:
                      parseInt(
                        Lampa.Storage.get('number_trend_week_film'),
                        10
                      ) || 8,
                  ...
                  },
                  {
                    id: 'upcoming',
                    order:
                      parseInt(Lampa.Storage.get('number_upcoming'), 10) || 9,
                    active: !Lampa.Storage.get('upcoming_remove'),
                  },
                  {
                    id: 'popular_movie',
                    order:
                      parseInt(Lampa.Storage.get('number_popular_movie'), 10) ||
                      10,
                  ...
                  },
                  {
                    id: 'popular_tv',
                    order:
                      parseInt(Lampa.Storage.get('number_popular_tv'), 10) ||
                      11,
                  ...
                  },
                  {
                    id: 'top_movie',
                    order:
                      parseInt(Lampa.Storage.get('number_top_movie'), 10) || 12,
                    active: !Lampa.Storage.get('top_movie_remove'),
                  },
                  {
                    id: 'top_tv',
                    order:
                      parseInt(Lampa.Storage.get('number_top_tv'), 10) || 13,
                    active: !Lampa.Storage.get('top_tv_remove'),
                  },
                  {
                    id: 'netflix',
                    order:
                      parseInt(Lampa.Storage.get('number_netflix'), 10) || 14,
                    active: !Lampa.Storage.get('netflix_remove'),
                  },
                  {
                    id: 'apple_tv',
                    order:
                      parseInt(Lampa.Storage.get('number_apple_tv'), 10) || 15,
                    active: !Lampa.Storage.get('apple_tv_remove'),
                  },
                  {
                    id: 'prime_video',
                    order:
                      parseInt(Lampa.Storage.get('number_prime_video'), 10) ||
                      16,
                  ...
                  },
                  {
                    id: 'dorams',
                    order:
                      parseInt(Lampa.Storage.get('number_dorams'), 10) || 19,
                    active: !Lampa.Storage.get('dorams_remove'),
                  },
                  {
                    id: 'tur_serials',
                    order:
                      parseInt(Lampa.Storage.get('number_tur_serials'), 10) ||
                      20,
                  ...
                  },
                  {
                    id: 'ind_films',
                    order:
                      parseInt(Lampa.Storage.get('number_ind_films'), 10) || 21,
                    active: !Lampa.Storage.get('ind_films_remove'),
                  },
                  {
                    id: 'rus_movie',
                    order:
                      parseInt(Lampa.Storage.get('number_rus_movie'), 10) || 22,
                    active: !Lampa.Storage.get('rus_movie_remove'),
                  },
                  {
                    id: 'rus_tv',
                    order:
                      parseInt(Lampa.Storage.get('number_rus_tv'), 10) || 23,
                    active: !Lampa.Storage.get('rus_tv_remove'),
                  },
                  {
                    id: 'rus_mult',
                    order:
                      parseInt(Lampa.Storage.get('number_rus_mult'), 10) || 24,
                    active: !Lampa.Storage.get('rus_mult_remove'),
                  },
                  {
                    id: 'start',
                    order:
                      parseInt(Lampa.Storage.get('number_start'), 10) || 25,
                    active: !Lampa.Storage.get('start_remove'),
                  },
                  {
                    id: 'premier',
                    order:
                      parseInt(Lampa.Storage.get('number_premier'), 10) || 26,
                  ...
                  },
                  {
                    id: 'kinopoisk',
                    order:
                      parseInt(Lampa.Storage.get('number_kinopoisk'), 10) || 30,
                  ...
                  },
                  {
                    ...
                    active: !Lampa.Storage.get(
                      'collections_inter_movie_remove'
                    ),
                  },
                  {
              ...
              function _0x32641f(_0x315295) {
                for (
                  var _0x20042f = _0x315295.length - 1;
                  _0x20042f > 0;
                  _0x20042f--
                ) {
                ...
                var _0x347081 = {
                    ...
                    trend_week_film: function (_0x33d26c) {
                      _0x35b9a9.get(
                        ...
                        function (_0x4a67f8) {
                          ...
                          Lampa.Storage.get('trend_week_film_shuffle') ==
                            true && _0x32641f(_0x4a67f8.results)
                          _0x33d26c(_0x4a67f8)
                        },
                        _0x33d26c
                      )
                    ...
                    upcoming: function (_0x58d175) {
                      _0x35b9a9.get(
                        ...
                        function (_0x5e0652) {
                          _0x5e0652.title =
                            Lampa.Lang.translate('title_upcoming')
                    ...
                    rus_movie: function (_0x46811f) {
                      _0x35b9a9.get(
                        ...
                        function (_0x43e855) {
                          _0x43e855.title =
                            Lampa.Lang.translate('Русские фильмы')
                    ...
                    collections_inter_movie: function (_0x468b35) {
                      _0x35b9a9.get(
                        ...
                        function (_0x281dc9) {
                          ...
                          Lampa.Storage.get(
                            'collections_inter_movie_display'
                          ) == '2' &&
                          ...
                          Lampa.Storage.get(
                            'collections_inter_movie_shuffle'
      ...
      Lampa.Api.sources.PersonalHub = _0x2357d4
      ...
      Lampa.SettingsApi.addParam({
        ...
        onRender: function (_0x304a5b) {
          setTimeout(function () {
            $('.settings-param > div:contains("Источник PersonalHub")')
              .parent()
              .insertAfter($('div[data-name="source"]'))
            Lampa.Storage.field('source') !== 'PersonalHub'
              ? _0x304a5b.hide()
              : _0x304a5b.show()
          }, 20)
      ...
      Lampa.Storage.listener.follow('change', function (_0x1c966a) {
        _0x1c966a.name == 'source' &&
          setTimeout(function () {
            Lampa.Storage.get('source') !== 'PersonalHub'
              ? $('.settings-param > div:contains("Источник PersonalHub")')
                  .parent()
                  .hide()
              : $('.settings-param > div:contains("Источник PersonalHub")')

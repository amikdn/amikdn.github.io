(function() {
    ...
    function _0x792fcb(_0x558e43) {
        setTimeout(function() {
            let apikey = '';
            let proto = servers[_0x558e43] === 'jr.maxvol.pro' ? 'https://' : protocol;
            const url = proto + servers[_0x558e43] + '/api/v2.0/indexers/status:healthy/results?apikey=' + apikey;
            ...
            const selector = 'body > div.selectbox > div.selectbox__content.layer--height > div.selectbox__body.layer--wheight > div > div > div > div:nth-child(' + (_0x558e43 + 2) + ') > div';

            xhr.ontimeout = xhr.onerror = function() {
                if ($(selector).text() === serverTitles[_0x558e43]) {
    ...
    Lampa.Storage.follow('parser', function() {

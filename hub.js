  ...
  (function () {
    ...
    function _0x559ec2() {
      ...
      var _0x175cd0 = function (_0x2d965e) {
        ...
        _0x287088.release_year = ((_0x287088.release_date || '0000') + '').slice(0x0, 0x4);
      ...
      var _0x35171b = function (_0x2719a3) {
        ...
        this.main = function () {
          var _0x35b9a9 = this;
          var _0x4d6097 = arguments.length > 0x0 && arguments[0x0] !== undefined ? arguments[0x0] : {};
          var _0x29b254 = arguments.length > 0x1 ? arguments[0x1] : undefined;
          var _0x652bd2 = arguments.length > 0x2 ? arguments[0x2] : undefined;
          var _0x31a0df = [{
            'id': "now_watch",
            'order': parseInt(Lampa.Storage.get('number_now_watch'), 0xa) || 0x1,
            ...
            'id': "trend_day",
            'order': parseInt(Lampa.Storage.get('number_trend_day'), 0xa) || 0x3,
            'active': !Lampa.Storage.get("trend_day_remove")
          }, {
            'id': "trend_day_tv",
            'order': parseInt(Lampa.Storage.get("number_trend_day_tv"), 0xa) || 0x4,
            'active': !Lampa.Storage.get("trend_day_tv_remove")
          }, {
            'id': "trend_day_film",
            'order': parseInt(Lampa.Storage.get("number_trend_day_film"), 0xa) || 0x5,
            'active': !Lampa.Storage.get("trend_day_film_remove")
          }, {
            'id': 'trend_week',
            'order': parseInt(Lampa.Storage.get("number_trend_week"), 0xa) || 0x6,
            'active': !Lampa.Storage.get('trend_week_remove')
          }, {
            'id': "trend_week_tv",
            'order': parseInt(Lampa.Storage.get('number_trend_week_tv'), 0xa) || 0x7,
            'active': !Lampa.Storage.get("trend_week_tv_remove")
          }, {
            'id': "trend_week_film",
            'order': parseInt(Lampa.Storage.get("number_trend_week_film"), 0xa) || 0x8,
            'active': !Lampa.Storage.get("trend_week_film_remove")
          }, {
            'id': 'upcoming',
            'order': parseInt(Lampa.Storage.get("number_upcoming"), 0xa) || 0x9,
            'active': !Lampa.Storage.get("upcoming_remove")
          }, {
            'id': "popular_movie",
            'order': parseInt(Lampa.Storage.get("number_popular_movie"), 0xa) || 0xa,
            'active': !Lampa.Storage.get("popular_movie_remove")
          }, {
            'id': 'popular_tv',
            'order': parseInt(Lampa.Storage.get("number_popular_tv"), 0xa) || 0xb,
            'active': !Lampa.Storage.get("popular_tv_remove")
          }, {
            'id': "top_movie",
            'order': parseInt(Lampa.Storage.get("number_top_movie"), 0xa) || 0xc,
            'active': !Lampa.Storage.get("top_movie_remove")
          }, {
            'id': "top_tv",
            'order': parseInt(Lampa.Storage.get("number_top_tv"), 0xa) || 0xd,
            'active': !Lampa.Storage.get("top_tv_remove")
          }, {
            'id': "netflix",
            'order': parseInt(Lampa.Storage.get('number_netflix'), 0xa) || 0xe,
            'active': !Lampa.Storage.get("netflix_remove")
          }, {
            'id': "apple_tv",
            'order': parseInt(Lampa.Storage.get('number_apple_tv'), 0xa) || 0xf,
            'active': !Lampa.Storage.get("apple_tv_remove")
          }, {
            'id': "prime_video",
            'order': parseInt(Lampa.Storage.get("number_prime_video"), 0xa) || 0x10,
            'active': !Lampa.Storage.get('prime_video_remove')
          }, {
            'id': "mgm",
            'order': parseInt(Lampa.Storage.get("number_mgm"), 0xa) || 0x11,
            'active': !Lampa.Storage.get("mgm_remove")
          }, {
            'id': "hbo",
            'order': parseInt(Lampa.Storage.get('number_hbo'), 0xa) || 0x12,
            'active': !Lampa.Storage.get('hbo_remove')
          }, {
            'id': "dorams",
            'order': parseInt(Lampa.Storage.get("number_dorams"), 0xa) || 0x13,
            'active': !Lampa.Storage.get('dorams_remove')
          }, {
            'id': "tur_serials",
            'order': parseInt(Lampa.Storage.get("number_tur_serials"), 0xa) || 0x14,
            'active': !Lampa.Storage.get("tur_serials_remove")
          }, {
            'id': 'ind_films',
            'order': parseInt(Lampa.Storage.get("number_ind_films"), 0xa) || 0x15,
            'active': !Lampa.Storage.get("ind_films_remove")
          }, {
            'id': 'rus_movie',
            'order': parseInt(Lampa.Storage.get("number_rus_movie"), 0xa) || 0x16,
            'active': !Lampa.Storage.get("rus_movie_remove")
          }, {
            'id': "rus_tv",
            'order': parseInt(Lampa.Storage.get("number_rus_tv"), 0xa) || 0x17,
            'active': !Lampa.Storage.get("rus_tv_remove")
          }, {
            'id': "rus_mult",
            'order': parseInt(Lampa.Storage.get('number_rus_mult'), 0xa) || 0x18,
            'active': !Lampa.Storage.get("rus_mult_remove")
          }, {
            'id': "start",
            'order': parseInt(Lampa.Storage.get("number_start"), 0xa) || 0x19,
            'active': !Lampa.Storage.get("start_remove")
          }, {
            'id': "premier",
            'order': parseInt(Lampa.Storage.get("number_premier"), 0xa) || 0x1a,
            'active': !Lampa.Storage.get("premier_remove")
          }, {
            'id': "kion",
            'order': parseInt(Lampa.Storage.get("number_kion"), 0xa) || 0x1b,
            'active': !Lampa.Storage.get("kion_remove")
          }, {
            'id': "ivi",
            'order': parseInt(Lampa.Storage.get("number_ivi"), 0xa) || 0x1c,
            'active': !Lampa.Storage.get("ivi_remove")
          }, {
            'id': "okko",
            'order': parseInt(Lampa.Storage.get('number_okko'), 0xa) || 0x1d,
            'active': !Lampa.Storage.get('okko_remove')
          }, {
            'id': 'kinopoisk',
            'order': parseInt(Lampa.Storage.get("number_kinopoisk"), 0xa) || 0x1e,
            'active': !Lampa.Storage.get("kinopoisk_remove")
          }, {
            'id': "wink",
            'order': parseInt(Lampa.Storage.get('number_wink'), 0xa) || 0x1f,
            'active': !Lampa.Storage.get("wink_remove")
          }, {
            'id': "sts",
            'order': parseInt(Lampa.Storage.get("number_sts"), 0xa) || 0x20,
            'active': !Lampa.Storage.get('sts_remove')
          }, {
            'id': "tnt",
            'order': parseInt(Lampa.Storage.get("number_tnt"), 0xa) || 0x21,
            'active': !Lampa.Storage.get("tnt_remove")
          }, {
            'id': "collections_inter_tv",
            'order': parseInt(Lampa.Storage.get("number_collections_inter_tv"), 0xa) || 0x22,
            'active': !Lampa.Storage.get('collections_inter_tv_remove')
          }, {
            'id': "collections_rus_tv",
            'order': parseInt(Lampa.Storage.get("number_collections_rus_tv"), 0xa) || 0x23,
            'active': !Lampa.Storage.get("collections_rus_tv_remove")
          }, {
            'id': "collections_inter_movie",
            'order': parseInt(Lampa.Storage.get("number_collections_inter_movie"), 0xa) || 0x24,
            'active': !Lampa.Storage.get("collections_inter_movie_remove")
          }, {
            'id': "collections_rus_movie",
            'order': parseInt(Lampa.Storage.get("number_collections_rus_movie"), 0xa) || 0x25,
            'active': !Lampa.Storage.get("collections_rus_movie_remove")
          }];
          var _0x430e36 = [];
          function _0x32641f(_0x315295) {
            for (var _0x20042f = _0x315295.length - 0x1; _0x20042f > 0x0; _0x20042f--) {
              var _0x21806d = Math.floor(Math.random() * (_0x20042f + 0x1));
          ...
          var _0x8b9af7 = new Date().toISOString().substr(0x0, 0xa);
          var _0x495bd6 = new Date(_0x8b9af7);
          _0x495bd6.setMonth(_0x495bd6.getMonth() - 0x1);
          function _0x41d373(_0x487474, _0x36ea97) {
            var _0x347081 = {
              ...
              'rus_movie': function (_0x46811f) {
                _0x35b9a9.get("discover/movie?vote_average.gte=5&vote_average.lte=9.5&with_original_language=ru&sort_by=primary_release_date.desc&primary_release_date.lte=" + new Date().toISOString().substr(0x0, 0xa), _0x4d6097, function (_0x43e855) {
              ...
              'rus_mult': function (_0x461a3f) {
                _0x35b9a9.get("discover/movie?vote_average.gte=5&vote_average.lte=9.5&with_genres=16&with_original_language=ru&sort_by=primary_release_date.desc&primary_release_date.lte=" + new Date().toISOString().substr(0x0, 0xa), _0x4d6097, function (_0x47690b) {
            ...
            if (_0x247a9f.length > 0x0) {
              Lampa.Api.partNext(_0x247a9f, 0x38, _0x487474, _0x36ea97);
            } else {
      ...
      Lampa.Settings.listener.follow('open', function (_0x1e6e1a) {
        if (_0x1e6e1a.name == "main") {
          if (Lampa.Settings.main().render().find("[data-component=\"bylampa_source\"]").length == 0x0) {
      ...
      function _0x5d2a93(_0x40a26e, _0x112a88, _0x26ceff, _0x4fe4e6, _0x1e7bb6, _0x43c5f2, _0x5c7f61) {
        var _0x383ed3 = _0x4f397f(this, function () {
          ...
          for (var _0x10a2fc = 0x0; _0x10a2fc < _0x164778.length; _0x10a2fc++) {
        ...
        Lampa.Settings.listener.follow('open', function (_0xc1fcd7) {
          if (_0xc1fcd7.name === "main") {
            if (Lampa.Settings.main().render().find("[data-component=\"" + _0x40a26e + "\"]").length === 0x0) {
              Lampa.SettingsApi.addComponent({
                'component': _0x40a26e,
                'name': _0x112a88
              });

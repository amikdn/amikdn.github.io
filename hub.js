(function () {
    ...
    var _0x175cd0 = function (_0x2d965e) {
            ...
            _0x287088.release_year = ((_0x287088.release_date || '0000') + '').slice(
                0,
                4
            )
                ...
                var _0x35b9a9 = this,
                    ...
                    _0x31a0df = [{
                        ...
                        },
                        {
                            ...
                            order: parseInt(Lampa.Storage.get('number_collections_rus_tv'), 10) ||
                                35,
                            ...
                            collections_inter_tv: function (_0x4f2a8c) {
                                _0x35b9a9.get(
                                    ...
                                    function (_0x634888) {
                                        ...
                                        Lampa.Storage.get('collections_inter_tv_display') == '2' &&
                                            ((_0x634888.collection = true),
                                                (_0x634888.line_type = 'collection'))
                                        Lampa.Storage.get('collections_inter_tv_display') == '3' &&
                                        ...
                                        Lampa.Storage.get('collections_inter_tv_display') == '4' &&
                                            (_0x634888.line_type = 'top')
                                        Lampa.Storage.get('collections_inter_tv_shuffle') == true &&
                            ...
                            collections_rus_movie: function (_0x572d04) {
                                _0x35b9a9.get(
                                    ...
                                    function (_0x207d7d) {
                                        ...
                                        Lampa.Storage.get('collections_rus_movie_display') == '2' &&
                                            ((_0x207d7d.collection = true),
                                                (_0x207d7d.line_type = 'collection'))
                                        Lampa.Storage.get('collections_rus_movie_display') == '3' &&
                                        ...
                                        Lampa.Storage.get('collections_rus_movie_display') == '4' &&
    ...
    Lampa.Settings.listener.follow('open', function (_0x1e6e1a) {
        _0x1e6e1a.name == 'main' &&
            (Lampa.Settings.main().render().find('[data-component="bylampa_source"]')
                .length == 0 &&
    ...
    _0x5d2a93('netflix', 'Netflix', 'Нажми для настройки', true, '1', '14', true)
    _0x5d2a93(
        'apple_tv',
        'Apple TV+',
        'Нажми для настройки',
    ...
    _0x5d2a93('dorams', 'Дорамы', 'Нажми для настройки', true, '1', '19', true)
    _0x5d2a93(
        'tur_serials',
        'Турецкие сериалы',
        'Нажми для настройки',
    ...
    _0x5d2a93('premier', 'Premier', 'Нажми для настройки', true, '1', '26', true)

;(function () {
  ...
  function _0x559ec2() {
      ...
      _0x35171b = function (_0x2719a3) {
        ...
        this.main = function () {
          var _0x35b9a9 = this,
            ...
            _0x31a0df = [
              ...
              },
              {
                id: 'trend_day_tv',
                order:
                  parseInt(Lampa.Storage.get('number_trend_day_tv'), 10) || 4,
                active: !Lampa.Storage.get('trend_day_tv_remove'),
              },
              {
                id: 'trend_day_film',
                order:
                  parseInt(Lampa.Storage.get('number_trend_day_film'), 10) || 5,
              ...
              },
              {
                id: 'trend_week_tv',
                order:
                  parseInt(Lampa.Storage.get('number_trend_week_tv'), 10) || 7,
                active: !Lampa.Storage.get('trend_week_tv_remove'),
              },
              {
                id: 'trend_week_film',
                order:
                  parseInt(Lampa.Storage.get('number_trend_week_film'), 10) ||
                  8,
              ...
              },
              {
                id: 'popular_movie',
                order:
                  parseInt(Lampa.Storage.get('number_popular_movie'), 10) || 10,
                active: !Lampa.Storage.get('popular_movie_remove'),
              },
              {
                id: 'popular_tv',
                order:
                  parseInt(Lampa.Storage.get('number_popular_tv'), 10) || 11,
              ...
              },
              {
                id: 'prime_video',
                order:
                  parseInt(Lampa.Storage.get('number_prime_video'), 10) || 16,
              ...
              },
              {
                id: 'tur_serials',
                order:
                  parseInt(Lampa.Storage.get('number_tur_serials'), 10) || 20,
          ...
          var _0x3c9a4e = [
            ...
            _0x23c0e2 = _0x3c9a4e[Math.floor(Math.random() * _0x3c9a4e.length)],
            _0x4286e1 = _0x23c0e2.start + '-01-01',
            _0x2e9161 = _0x23c0e2.end + '-12-31',
            _0x4098a9 = _0x3c9a4e[Math.floor(Math.random() * _0x3c9a4e.length)],
            _0xad85fd = _0x4098a9.start + '-01-01',
            _0x327e18 = _0x4098a9.end + '-12-31',
            _0x34e9d8 = ['vote_count.desc', 'popularity.desc', 'revenue.desc'],
            _0x483e39 = Math.floor(Math.random() * _0x34e9d8.length),
            _0x59d435 = _0x34e9d8[_0x483e39],
            _0x20e36a = ['vote_count.desc', 'popularity.desc', 'revenue.desc'],
                ...
                collections_rus_tv: function (_0x424874) {
                  _0x35b9a9.get(
                    ...
                    function (_0x3ce909) {
                      ...
                      Lampa.Storage.get('collections_rus_tv_display') == '2' &&
                        ((_0x3ce909.collection = true),
                        (_0x3ce909.line_type = 'collection'))
                      Lampa.Storage.get('collections_rus_tv_display') == '3' &&
                      ...
                      Lampa.Storage.get('collections_rus_tv_display') == '4' &&
                        (_0x3ce909.line_type = 'top')
                      Lampa.Storage.get('collections_rus_tv_shuffle') == true &&
    ...
    Lampa.Params.select(
      'source',
      Object.assign({}, Lampa.Params.values.source, { bylampa: 'ByLAMPA' }),
      'tmdb'
    )

(function () {
    ...
    (function () {
        function initPlugin() {
            ...
            // HTML для списка (точно как в вашем примере)
            ...
            function RusMovieCollection(params) {
                ...
                component.use({
                    onCreate: function () {
                        ...
                        var gridIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24"><path fill="currentColor" d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z"/></svg>';
                        var listIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24"><path fill="currentColor" d="M4 14h4v-4H4v4zm0 5h4v-4H4v4zM4 9h4V5H4v4zm6 5h10v-4H10v4zm0 5h10v-4H10v4zm0-10v4h10V9H10z"/></svg>';

                        if (view === 'grid') {
                            this.body.addClass('mapping--grid cols--5');

                            var results = collections.map(function (item) {
                                return {
                                    title: item.title,
                                    img: item.img,
                                    params: {
                            ...
                            this.body.removeClass('mapping--grid cols--5');

                            var listHtmls = [rusFilms, rusSeries, rusCartoons, start, premier, kion, ivi, okko, kinopoisk, wink, sts, tnt];

                            var listActivities = [
                                { url: '?cat=movie&airdate=2023-2025&without_genres=16&language=ru', title: 'Русские фильмы', component: 'category_full', source: 'cub', page: 1 },
                                { url: 'discover/tv?with_original_language=ru&sort_by=first_air_date.desc', title: 'Русские сериалы', component: 'category_full', source: 'tmdb', page: 1 },
                                { url: '?cat=movie&airdate=2020-2025&genre=16&language=ru', title: 'Русские мультфильмы', component: 'category_full', source: 'cub', page: 1 },
                                { url: 'discover/tv', title: 'Start', component: 'category_full', source: 'tmdb', page: 1, networks: '2493', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'Premier', component: 'category_full', source: 'tmdb', page: 1, networks: '2859', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'KION', component: 'category_full', source: 'tmdb', page: 1, networks: '4085', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'ИВИ', component: 'category_full', source: 'tmdb', page: 1, networks: '3923', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'Okko', component: 'category_full', source: 'tmdb', page: 1, networks: '3871', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'КиноПоиск', component: 'category_full', source: 'tmdb', page: 1, networks: '3827', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'Wink', component: 'category_full', source: 'tmdb', page: 1, networks: '5806', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'СТС', component: 'category_full', source: 'tmdb', page: 1, networks: '806', sort_by: 'first_air_date.desc' },
                                { url: 'discover/tv', title: 'ТНТ', component: 'category_full', source: 'tmdb', page: 1, networks: '1191', sort_by: 'first_air_date.desc' }
                            ];

                            var results = listHtmls.map(function (html, i) {
                                return {
                                    title: html,
                                    img: '',
                                    data: listActivities[i]
                                };
                            });
                        ...
                        var toggleIcon = view === 'grid' ? listIcon : gridIcon;
                        var $toggleButton = $('<div class="category__view selector" style="position:absolute;right:1em;top:0.3em;z-index:10;">' + toggleIcon + '</div>');

                        $toggleButton.on('hover:enter', function () {
                            var newView = view === 'grid' ? 'list' : 'grid';
                            Lampa.Storage.set('rus_movie_view', newView);

;(function () {
  ...
  function initPlugin() {
    ...
    // Маленькие SVG для плиток в меню "Русское"
      ...
      category.use({
        onCreate: function () {
          ...
          setTimeout(() => {
            const data = {
              results: [
                { title: 'Русские фильмы', img: 'https://amikdn.github.io/img/rus_movie.jpg', data: { url: `discover/movie?sort_by=primary_release_date.desc&with_original_language=ru&vote_average.gte=5&vote_average.lte=9.5&primary_release_date.lte=${today}`, title: 'Русские фильмы', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'Русские сериалы', img: 'https://amikdn.github.io/img/rus_tv.jpg', data: { url: `discover/tv?sort_by=first_air_date.desc&with_original_language=ru&air_date.lte=${today}`, title: 'Русские сериалы', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'Русские мультфильмы', img: 'https://amikdn.github.io/img/rus_mult.jpg', data: { url: `discover/movie?sort_by=primary_release_date.desc&vote_average.gte=5&vote_average.lte=9.5&with_genres=16&with_original_language=ru&primary_release_date.lte=${today}`, title: 'Русские мультфильмы', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'Start', img: 'https://amikdn.github.io/img/start.jpg', data: { url: `discover/tv?with_networks=2493&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'Start', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'Premier', img: 'https://amikdn.github.io/img/premier.jpg', data: { url: `discover/tv?with_networks=2859&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'Premier', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'KION', img: 'https://amikdn.github.io/img/kion.jpg', data: { url: `discover/tv?with_networks=4085&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'KION', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'ИВИ', img: 'https://amikdn.github.io/img/ivi.jpg', data: { url: `discover/tv?with_networks=3923&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'ИВИ', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'Okko', img: 'https://amikdn.github.io/img/okko.jpg', data: { url: `discover/tv?with_networks=3871&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'Okko', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'КиноПоиск', img: 'https://amikdn.github.io/img/kinopoisk.jpg', data: { url: `discover/tv?with_networks=3827&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'КиноПоиск', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'Wink', img: 'https://amikdn.github.io/img/wink.jpg', data: { url: `discover/tv?with_networks=5806&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'Wink', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'СТС', img: 'https://amikdn.github.io/img/sts.jpg', data: { url: `discover/tv?with_networks=806&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'СТС', component: 'category_full', source: 'tmdb', page: 1 } },
                { title: 'ТНТ', img: 'https://amikdn.github.io/img/tnt.jpg', data: { url: `discover/tv?with_networks=1191&sort_by=first_air_date.desc&air_date.lte=${today}`, title: 'ТНТ', component: 'category_full', source: 'tmdb', page: 1 } },
              ].map(i => ({ title: i.title, img: i.img, params: { style: { name: 'collection' } }, data: i.data }))
            };
            this.build(data);
    ...
    menuItem.on('hover:enter', () => Lampa.Activity.push({ url: '', title: 'Русское', component: 'rus_movie', page: 1 }));
    ...
    Lampa.SettingsApi.addParam({
      ...
      field: { name: 'Русские новинки на главной', description: 'Показывать подборки русских новинок на главной странице. После изменения перезапустите приложение (работает только с TMDB)' },
      onRender: el => setTimeout(() => $('div[data-name="rus_movie_main"]').insertAfter('div[data-name="interface_size"]'), 0)
    });

    // Переопределение main при включённой настройке
    if (Lampa.Storage.get('rus_movie_main') !== false) {
      const extendedMain = function (source) {
        this.network = new Lampa.Reguest();

        this.main = function () {
          const years = [{start:2023,end:2025},{start:2020,end:2022},{start:2017,end:2019},{start:2014,end:2016},{start:2011,end:2013}];
          const range1 = years[Math.floor(Math.random() * years.length)];
          const range2 = years[Math.floor(Math.random() * years.length)];
          const sort1 = ['vote_count.desc','vote_average.desc','popularity.desc','revenue.desc'][Math.floor(Math.random()*4)];
          const sort2 = ['vote_count.desc','popularity.desc','revenue.desc'][Math.floor(Math.random()*3)];

          const lines = [
            // Стандартные + русские (точно как в примере)
            cb => this.network.get('movie/now_playing', {}, data => {
            ...
            cb => this.network.get('trending/all/day', {}, data => {
            ...
            cb => this.network.get('trending/all/week', {}, data => {
            ...
            cb => this.network.get('movie/upcoming', {}, data => {
            ...
            cb => this.network.get('movie/popular', {}, data => {
            ...
            cb => this.network.get('trending/tv/week', {}, data => {
            ...
            cb => this.network.get(`discover/movie?primary_release_date.gte=${range2.start}-01-01&primary_release_date.lte=${range2.end}-12-31&vote_average.gte=5&vote_average.lte=9.5&with_original_language=ru&sort_by=${sort2}`, {}, data => {
            ...
            cb => this.network.get(`discover/tv?first_air_date.gte=${range1.start}-01-01&first_air_date.lte=${range1.end}-12-31&with_networks=2493|2859|4085|3923|3871|3827|5806|806|1191&sort_by=${sort1}`, {}, data => {
            ...
            cb => this.network.get(`discover/tv?with_networks=2493&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'Start';
            ...
            cb => this.network.get(`discover/tv?with_networks=2859&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'Premier';
            ...
            cb => this.network.get(`discover/tv?with_networks=4085&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'KION';
            ...
            cb => this.network.get(`discover/tv?with_networks=3923&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'ИВИ';
            ...
            cb => this.network.get(`discover/tv?with_networks=3871&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'Okko';
            ...
            cb => this.network.get(`discover/tv?with_networks=3827&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
            ...
            cb => this.network.get(`discover/tv?with_networks=5806&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'Wink';
            ...
            cb => this.network.get(`discover/tv?with_networks=806&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'СТС';
            ...
            cb => this.network.get(`discover/tv?with_networks=1191&sort_by=first_air_date.desc&air_date.lte=${today}`, {}, data => {
              data.title = 'ТНТ';
            ...
            cb => this.network.get('movie/top_rated', {}, data => {
            ...
            cb => this.network.get('tv/top_rated', {}, data => {
      ...
      // Force reload главной при tmdb
      if (Lampa.Storage.get('source') === 'tmdb') {
        setInterval(() => {
          const active = Lampa.Activity.active();
          if (active && active.component === 'main' && !$('div.settings__content').length) {
            clearInterval(this);
            Lampa.Activity.replace({
              source: 'tmdb',
              title: Lampa.Lang.translate('title_main') + ' - TMDB'
            });
          }
        }, 200);
      }

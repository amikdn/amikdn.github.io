  ...
  ;(function () {
    function initRussianPlugin() {
      ...
      function EpisodeCard(cardData, episodeData) {
        ...
        const episode = episodeData.next_episode_to_air || episodeData.episode || {};
      ...
      if (Lampa.Storage.get('rus_movie_main') !== false) {
        class RussianMainSource {
          ...
          main(params = {}, onSuccess, onError) {
            ...
            const randomYears1 = yearsRanges[Math.floor(Math.random() * yearsRanges.length)];
            const randomYears2 = yearsRanges[Math.floor(Math.random() * yearsRanges.length)];

            const dateFrom1 = randomYears1.start + '-01-01';
            const dateTo1 = randomYears1.end + '-12-31';
            const dateFrom2 = randomYears2.start + '-01-01';
            const dateTo2 = randomYears2.end + '-12-31';
            ...
            const requests = [
              (callback) => {
                this.base.get('movie/now_playing', params, (data) => {
              ...
              (callback) => {
                this.base.get('trending/all/day', params, (data) => {
              ...
              (callback) => {
                this.base.get('trending/all/week', params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/movie?vote_average.gte=5&vote_average.lte=9.5&with_original_language=ru&sort_by=primary_release_date.desc&primary_release_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_original_language=ru&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('movie/upcoming', params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/movie?vote_average.gte=5&vote_average.lte=9.5&with_genres=16&with_original_language=ru&sort_by=primary_release_date.desc&primary_release_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('movie/popular', params, (data) => {
              ...
              (callback) => {
                this.base.get('trending/tv/week', params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/movie?primary_release_date.gte=' + dateFrom2 + '&primary_release_date.lte=' + dateTo2 + '&vote_average.gte=5&vote_average.lte=9.5&with_original_language=ru&sort_by=' + randomSort2, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?first_air_date.gte=' + dateFrom1 + '&first_air_date.lte=' + dateTo1 + '&with_networks=2493|2859|4085|3923|3871|3827|5806|806|1191&sort_by=' + randomSort1, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=2493&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=2859&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=4085&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=3923&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=3871&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=3827&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=5806&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=806&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('discover/tv?with_networks=1191&sort_by=first_air_date.desc&air_date.lte=' + today, params, (data) => {
              ...
              (callback) => {
                this.base.get('movie/top_rated', params, (data) => {
              ...
              (callback) => {
                this.base.get('tv/top_rated', params, (data) => {
            ...
            const personIndex = requests.length + 1;
            Lampa.Arrays.insert(requests, 0, Lampa.Api.partPersons(requests, 6, 'movie', personIndex));

            params.genres.movie.forEach(genre => {
              requests.push((callback) => {
                this.base.get('discover/movie?with_genres=' + genre.id, params, (data) => {
      ...
      Lampa.Template.add('tnt_icon', '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Слой_1" x="0px" y="0px" viewBox="0 0 1000 330.745636" enable-background="new 0 0 1000 330.745636" xml:space="preserve"><path fill-rule="evenodd" clip-rule="evenodd" fill="#F9CA8C" d="M444.4538879,121.4398499h111.1193542V11.2740288H444.4538879  V121.4398499z M444.4538879,319.7213135h111.1193542V209.5554199H444.4538879V319.7213135z M936.3792114,319.4742432  c42.7337036,0,52.557373-9.7634277,52.557373-52.1082153V99.1432877H888.9332275v220.3309631H936.3792114z M730.2888184,319.4742432  h47.5232544l-0.0823364-220.3309631h-99.9991455v168.2227478  C677.7305908,309.7379456,687.578125,319.4742432,730.2888184,319.4742432z M322.2405396,267.3660278  c0,42.3447876-9.819519,52.1082153-52.5582581,52.1082153h-47.4400482V99.1432877h99.9983063V267.3660278z M111.1219559,319.4742432  H63.6236572c-42.7104836,0-52.5579071-9.7362976-52.5579071-52.1082153V99.1432877h100.0562057V319.4742432z M1000,62.9481392  C1000,14.3997927,985.4299316,0,936.4047241,0H730.2888184c-49.0736694,0-63.623291,14.4272175-63.623291,63.0777893v0.2741661  c0-48.6505737-14.5224609-63.1051483-63.6241455-63.1051483H396.9577942c-49.0736694,0-63.624176,14.4545746-63.624176,63.0777206  v-0.2467384C333.3336182,14.4272175,318.7839661,0,269.7102966,0H63.6236572C14.5526257,0,0,14.4272175,0,63.0777893V267.394043  c0,48.6524963,14.5526257,63.0773621,63.6236572,63.0773621h206.0866394c49.0736694,0,63.6233215-14.4248657,63.6233215-63.0773621  v0.274231c0,48.6525574,14.5776672,63.0773621,63.624176,63.0773621h206.0835876  c49.0736084,0,63.6241455-14.4248047,63.6241455-63.0773621v-0.274231c0,48.6524963,14.5496216,63.0773621,63.623291,63.0773621  h206.0903931c48.5922241,0,63.3320923-14.1480713,63.6123047-61.6815186L1000,62.9481392z"/></svg>');

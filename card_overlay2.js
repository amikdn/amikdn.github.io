(function () {
    ...
    function initPlugin() {
        ...
        style.textContent =
            ...
            '.card__vote > span:first-child,.card__vote-line .card__rate-item > div,.card__vote-line .card__rate-item > .rate-value{display:inline-block!important;min-width:3ch!important;text-align:left!important;vertical-align:middle!important;line-height:1!important;height:1em!important}' +
            ...
            '.card__vote .source--name{font-size:0!important;display:inline-block!important;color:transparent!important;width:var(--card-overlay-icon-size,12px)!important;height:var(--card-overlay-icon-size,12px)!important;line-height:var(--card-overlay-icon-size,12px)!important;min-width:var(--card-overlay-icon-size,12px)!important;min-height:var(--card-overlay-icon-size,12px)!important;overflow:hidden!important;background-repeat:no-repeat!important;background-position:center!important;background-size:contain!important;margin-left:0.25em!important;padding:0!important;border:none!important;vertical-align:middle!important}' +
            ...
            '.rate-icon-reaction{background-repeat:no-repeat;background-position:center;background-size:contain;display:inline-block!important;vertical-align:middle!important;width:var(--card-overlay-icon-size,12px)!important;height:var(--card-overlay-icon-size,12px)!important;line-height:var(--card-overlay-icon-size,12px)!important;min-width:var(--card-overlay-icon-size,12px)!important;min-height:var(--card-overlay-icon-size,12px)!important}' +
            ...
            '.card__vote.rate--lampa img{display:inline-block!important;vertical-align:middle!important;max-height:var(--card-overlay-lampa-icon-size,12px)!important;max-width:var(--card-overlay-lampa-icon-size,12px)!important;min-width:0!important;min-height:0!important;object-fit:contain!important;margin-left:auto!important;height:var(--card-overlay-lampa-icon-size,12px)!important;width:var(--card-overlay-lampa-icon-size,12px)!important;flex-shrink:0!important}' +

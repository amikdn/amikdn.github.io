(function () {
    ...
    function resetCacheSaveState(source) {
        _saveVersion[source] = (_saveVersion[source] || 0) + 1;
        _savePending[source] = false;
    }
    ...
    function clearRatingCaches(includeQuality) {
        ...
        if (includeQuality) clearStorageObject(QUALITY_CACHE_KEY);
    }
    ...
    function applyRatingScale() {
        ...
        try {
            document.body.style.setProperty('--rating-font-size', (1.1 * v / 100) + 'em');
            document.body.style.setProperty('--card-overlay-font-size', (1.1 * v / 100) + 'em');
            document.body.style.setProperty('--card-overlay-radius', (0.75 * v / 100) + 'em');
            document.body.style.setProperty('--card-overlay-padding-y', (0.25 * v / 100) + 'em');
            document.body.style.setProperty('--card-overlay-padding-x', (0.45 * v / 100) + 'em');
            document.body.style.setProperty('--card-overlay-icon-size', (12 * v / 100) + 'px');
            document.body.style.setProperty('--card-overlay-icon-size-desktop', (18 * v / 100) + 'px');
            document.body.style.setProperty('--card-overlay-lampa-icon-size', (12 * v / 100) + 'px');
            document.body.style.setProperty('--card-overlay-lampa-icon-size-desktop', (18 * v / 100) + 'px');
        } catch (e) {}
    }
    ...
    function updateEpisodeLabelPosition(card) {
        ...
        var typeStyle = typeLabel ? window.getComputedStyle(typeLabel) : null;
        if (typeStyle) {
            label.style.setProperty('font-size', typeStyle.fontSize, 'important');
            label.style.setProperty('line-height', typeStyle.lineHeight === 'normal' ? '1' : typeStyle.lineHeight, 'important');
            label.style.setProperty('padding', typeStyle.paddingTop + ' ' + typeStyle.paddingRight + ' ' + typeStyle.paddingBottom + ' ' + typeStyle.paddingLeft, 'important');
        }
        if (isEpisodeLabelUnderType()) {
            var topOffset = 0;
            if (typeLabel && typeStyle) {
                var fontSize = parseFloat(typeStyle.fontSize) || 0;
                var paddingBottom = parseFloat(typeStyle.paddingBottom) || 0;
                var gap = Math.max(2, Math.round((fontSize + paddingBottom) * 0.12));
                topOffset = typeLabel.offsetTop + typeLabel.offsetHeight + gap;
            }
    ...
    function initPlugin() {
        ...
        style.textContent =
            ...
            '.card__vote,.card__vote-separate-wrap .card__vote{position:absolute!important;right:0!important;bottom:0!important;padding:var(--card-overlay-padding-y,0.25em) var(--card-overlay-padding-x,0.45em)!important;border-radius:var(--card-overlay-radius,0.75em) 0!important;white-space:nowrap!important;font-size:var(--card-overlay-font-size,1.1em)!important;font-weight:400!important;line-height:1!important;height:auto!important;border:none!important;margin:0!important;box-sizing:border-box!important;display:inline-flex!important;align-items:center!important;justify-content:flex-start!important;gap:0.25em!important}' +
            ...
            '.card__vote-line{position:absolute!important;right:0!important;bottom:0!important;padding:var(--card-overlay-padding-y,0.25em) var(--card-overlay-padding-x,0.45em)!important;border-radius:var(--card-overlay-radius,0.75em) 0!important;font-size:var(--card-overlay-font-size,1.1em)!important;font-weight:400!important;line-height:1!important;height:auto!important;border:none!important;margin:0!important;box-sizing:border-box!important}' +
            '.card__vote-separate-wrap{position:absolute!important;background:transparent!important;padding:0!important;width:auto!important;min-width:0!important;max-width:100%!important;overflow:visible!important;font-size:var(--card-overlay-font-size,1.1em)!important;font-weight:400!important;box-sizing:border-box!important}' +
            ...
            '.card__vote .source--name{font-size:0!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;color:transparent!important;width:var(--card-overlay-icon-size,12px)!important;height:var(--card-overlay-icon-size,12px)!important;min-width:var(--card-overlay-icon-size,12px)!important;min-height:var(--card-overlay-icon-size,12px)!important;overflow:hidden!important;background-repeat:no-repeat!important;background-position:center!important;background-size:contain!important;margin-left:0!important;padding:0!important;border:none!important;vertical-align:middle!important;line-height:1!important;flex-shrink:0!important}' +
            '@media (min-width:481px){.card__vote .source--name{width:var(--card-overlay-icon-size-desktop,18px)!important;height:var(--card-overlay-icon-size-desktop,18px)!important}}' +
            '@media (min-width:481px){.card__vote,.card__vote-line,.card__vote-separate-wrap,.card__vote-separate-wrap .card__vote{font-size:var(--card-overlay-font-size,1.1em)!important}}' +
            ...
            '.rate-icon-reaction{background-repeat:no-repeat;background-position:center;background-size:contain;display:inline-flex!important;align-items:center!important;justify-content:center!important;width:var(--card-overlay-icon-size,12px)!important;height:var(--card-overlay-icon-size,12px)!important;min-width:var(--card-overlay-icon-size,12px)!important;min-height:var(--card-overlay-icon-size,12px)!important;line-height:1!important;flex-shrink:0!important}' +
            ...
            '.card__vote.rate--lampa img{display:block!important;max-height:var(--card-overlay-lampa-icon-size,12px)!important;max-width:var(--card-overlay-lampa-icon-size,12px)!important;min-width:var(--card-overlay-lampa-icon-size,12px)!important;min-height:var(--card-overlay-lampa-icon-size,12px)!important;object-fit:contain!important;margin-left:0!important;height:var(--card-overlay-lampa-icon-size,12px)!important;width:var(--card-overlay-lampa-icon-size,12px)!important;flex-shrink:0!important}' +
            '@media (min-width:481px){.card__vote.rate--lampa img{max-height:var(--card-overlay-lampa-icon-size-desktop,18px)!important;max-width:var(--card-overlay-lampa-icon-size-desktop,18px)!important}}' +
            '.rate--lampa.rate--lampa--animated .rate-icon img{width:calc(var(--card-overlay-lampa-icon-size,12px) * 1.17)!important;height:calc(var(--card-overlay-lampa-icon-size,12px) * 1.17)!important;max-height:none!important;max-width:none!important;object-fit:contain;display:block!important;margin-left:auto!important}' +
            ...
            '.card__quality{position:absolute!important;left:0!important;bottom:0!important;padding:var(--card-overlay-padding-y,0.25em) var(--card-overlay-padding-x,0.45em)!important;border-radius:0 var(--card-overlay-radius,0.75em)!important;color:white!important;font-size:var(--card-overlay-font-size,1.1em)!important;line-height:1!important;z-index:10!important;white-space:nowrap!important}' +
            '.card__episode-label{position:absolute!important;left:50%!important;right:auto!important;bottom:0!important;top:auto!important;transform:translateX(-50%)!important;color:white!important;padding:var(--card-overlay-padding-y,0.25em) var(--card-overlay-padding-x,0.45em)!important;border-radius:var(--card-overlay-radius,0.75em) var(--card-overlay-radius,0.75em) 0 0!important;font-size:var(--card-overlay-font-size,1.1em)!important;font-weight:400!important;line-height:1!important;height:auto!important;z-index:10!important;white-space:nowrap!important;box-sizing:border-box!important;margin:0!important;border:none!important}' +
            '.content-label,.card__type[data-card-overlay-type-label="1"]{position:absolute!important;left:0!important;top:0!important;color:white!important;padding:var(--card-overlay-padding-y,0.25em) var(--card-overlay-padding-x,0.45em)!important;border-radius:var(--card-overlay-radius,0.75em) 0!important;font-size:var(--card-overlay-font-size,1.1em)!important;line-height:1!important;z-index:10!important;display:flex!important;align-items:center!important;justify-content:center!important}' +

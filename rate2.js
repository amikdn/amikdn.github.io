(function () {
    ...
    function initPlugin() {
        ...
        style.textContent = (
            ...
            '.rate--lampa .source--name.rate-icon-reaction{background-size:85%}' +
            '.card__vote.rate--lampa{line-height:1!important}' +
            '.card__vote.rate--lampa img{width:16px!important;height:16px!important;min-width:0!important;min-height:0!important;max-width:16px!important;max-height:16px!important;object-fit:contain!important;-webkit-flex-shrink:0;flex-shrink:0;vertical-align:middle;margin-left:4px!important;transform:scale(0.88)!important;transform-origin:center center!important}' +
            '@media (min-width:481px){.rate--lampa .source--name.rate-icon-reaction{background-size:85%}.card__vote.rate--lampa img{width:24px!important;height:24px!important;max-width:24px!important;max-height:24px!important;margin-left:6px!important;transform:scale(0.88)!important}}' +

    ...
    function add() {
        ...
        function updateT() {
            if(Lampa.Storage.field('BUTTONS_fix') == true) {
                ...
                /* Кнопка Консоли */
                var my_console = '<div id="CONSOLE" class="head__action selector console-screen hide"><svg width="64px" height="64px" viewBox="0 0 1024 1024" class="icon" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff" stroke-width="20.48"><g></g><g></g><g><path d="M877.685565 727.913127l-0.584863-0.365539a32.898541 32.898541 0 0 1-8.041866-46.423497 411.816631 411.816631 0 1 0-141.829267 145.777092c14.621574-8.992268 33.62962-5.117551 43.645398 8.772944l0.146216 0.073108a30.412874 30.412874 0 0 1-7.968758 43.206751l-6.141061 4.020933a475.201154 475.201154 0 1 1 163.615412-164.419599 29.974227 29.974227 0 0 1-42.841211 9.357807z" fill="currentColor"></path></g></svg></div>';
                ...
                */
                ...
                if (Lampa.Storage.field('NoTimeNoDate') == true) {
                    ...
                    var notimedatescreenInterval = setInterval(function() {
                        ...
                        if (elementScreenSaver.length > 0){
                            // Если требуется, можно добавить дополнительные манипуляции с iframe заставки
                        }
                    }, 1000);
                }
                ...
                if (Lampa.Storage.field('NavyBar') == true)	{
                    ...
                    var searchReturnButton = '<div id="searchReturnButton" class="head__action head__settings selector searchReturnButton"><svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="9.9964" cy="9.63489" r="8.43556" stroke="currentColor" stroke-width="2.4"></circle><path d="M20.7768 20.4334L18.2135 17.8701" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"></path></svg></div>';
                ...
                /* Активация кнопки возврата на экране */
                ...
                setInterval(function() {
                    var exitSVG = '<div id="ExitButton" class="button selector" data-controller="player_panel"><svg viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"><g></g><g><path d="M3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12Z" stroke="#000000" stroke-width="2"></path><path d="M9 9L15 15M15 9L9 15" stroke="#000000" stroke-width="2" stroke-linecap="round"></path></g></svg></div>';
                    $('#ExitButton').remove();
                    if (Lampa.Storage.field('BackButton') == true){
                ...
                /* Запускаем обновление кнопок каждую секунду */
                setInterval(updateT, 1000);
                
                /* Отключение неиспользуемых языковых раскладок */
                setInterval(function() {
                ...
                /* Удаление раздела "Клубничка" при включённом SISI_fix */
                ...
                var TubeSVG = '<svg width="256px" height="256px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff" stroke-width="0.00048"><g><title>youtube</title><g><path d="M45.1,12.8a5.5,5.5,0,0,0-3.9-3.9C37.8,8,24,8,24,8S10.2,8,6.8,8.9a5.5,5.5,0,0,0-3.9,3.9C2,16.2,2,23.4,2,23.4s0,7.2.9,10.6a5.5,5.5,0,0,0,3.9,3.9c3.4.9,17.2.9,17.2.9s13.8,0,17.2-.9A5.5,5.5,0,0,0,45.1,34c.9-3.4.9-10.6.9-10.6S46,16.2,45.1,12.8ZM19.6,30V16.8L31,23.4Z"/></g></g></svg>';
                ...
                rutubemenu.on('hover:enter', function() {
                    ...
                    else window.open('https://bit.ly/3DnLr2O', '_blank');
                });
                ...
                var TwitchSVG = '<svg width="256px" height="256px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff"><g><rect x="0" fill="none" width="20" height="20"></rect><g><style>.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><path d="M2.7 2L2 4.6v11.8h3.2V18H7l1.8-1.6h2.9l5.7-5.2V2H2.7zM16 10.5l-2.5 2.3h-4l-2.2 2v-2H4.2V3.3H16v7.2zm-2.5-4.6h-1.4v3.9h1.4V5.9zm-4 0H8.1v3.9h1.4V5.9z"></path></g></g></svg>';
                ...
                /* Кнопка YouTube */
                // (настройка через параметр YouTube выше)
                
                /* Кнопка RuTube */
                // (настройка через параметр RuTube выше)
                
                /* Кнопка Twitch */
                // (настройка через параметр Twitch выше)
                
                /* Остальные шаблоны и динамические изменения элементов интерфейса */
                // Здесь продолжается код по добавлению дополнительных кнопок, стилей, обновлений часов и т.д.
            }
        }

(function () {
    ...
    function addSettings() {
        ...
        var inlineParams = [
            { param: { name: 'rating_source', type: 'select', values: { tmdb: 'TMDB', lampa: 'Lampa', all: 'Оба' }, default: 'tmdb' }, field: { name: 'Источник' } },
            { param: { name: 'rating_display_mode', type: 'select', values: { single: 'Одно окно', separate: 'Каждый в отдельном окне' }, default: 'single' }, field: { name: 'Режим отображения (режим «Оба»)' } },
            ...
            { param: { name: 'rating_show_tmdb', type: 'trigger', default: true }, field: { name: 'Показывать TMDB (режим «Оба»)' } },
            { param: { name: 'rating_show_lampa', type: 'trigger', default: true }, field: { name: 'Показывать Lampa (режим «Оба»)' } },

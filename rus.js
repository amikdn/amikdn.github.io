;(function () {
    ...
    // Надёжное добавление пункта "Русское" в меню с MutationObserver
    (function () {
        function addRussianMenuItem() {
        ...
        // MutationObserver для ожидания появления меню
        ...
        // Немедленная попытка, если меню уже есть
        addRussianMenuItem();

        // Listener для готовности
        if (Lampa.Listener) {

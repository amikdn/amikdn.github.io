;(function () {
    ...
    // Новый плагин: "Русское" как отдельный компонент с большими карточками-иконками + расширение главной страницы
    (function () {
        function initPlugin() {
            ...
            // Список карточек-коллекций с иконками
            var collections = [
                {
                    title: 'Русские фильмы',
                    img: 'https://bylampa.github.io/img/rus_movie.jpg',
                    request: 'discover/movie?sort_by=primary_release_date.desc&with_original_language=ru&vote_average.gte=5&vote_average.lte=9.5&primary_release_date.lte=' + currentDate
                },
                {
                    title: 'Русские сериалы',
                    img: 'https://bylampa.github.io/img/rus_tv.jpg',
                    request: 'discover/tv?sort_by=first_air_date.desc&with_original_language=ru&air_date.lte=' + currentDate
                },
                {
                    title: 'Русские мультфильмы',
                    img: 'https://bylampa.github.io/img/rus_mult.jpg',
                    request: 'discover/movie?sort_by=primary_release_date.desc&vote_average.gte=5&vote_average.lte=9.5&with_genres=16&with_original_language=ru&primary_release_date.lte=' + currentDate
                },
                {
                    title: 'Start',
                    img: 'https://bylampa.github.io/img/start.jpg',
                    request: 'discover/tv?with_networks=2493&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'Premier',
                    img: 'https://bylampa.github.io/img/premier.jpg',
                    request: 'discover/tv?with_networks=2859&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'KION',
                    img: 'https://bylampa.github.io/img/kion.jpg',
                    request: 'discover/tv?with_networks=4085&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'ИВИ',
                    img: 'https://bylampa.github.io/img/ivi.jpg',
                    request: 'discover/tv?with_networks=3923&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'Okko',
                    img: 'https://bylampa.github.io/img/okko.jpg',
                    request: 'discover/tv?with_networks=3871&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'КиноПоиск',
                    img: 'https://bylampa.github.io/img/kinopoisk.jpg',
                    request: 'discover/tv?with_networks=3827&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'Wink',
                    img: 'https://bylampa.github.io/img/wink.jpg',
                    request: 'discover/tv?with_networks=5806&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'СТС',
                    img: 'https://bylampa.github.io/img/sts.jpg',
                    request: 'discover/tv?with_networks=806&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                },
                {
                    title: 'ТНТ',
                    img: 'https://bylampa.github.io/img/tnt.jpg',
                    request: 'discover/tv?with_networks=1191&sort_by=first_air_date.desc&air_date.lte=' + currentDate
                }
            ];

            // Функция для главной коллекции (rus_movie)
                ...
                var data = {
                    ...
                    results: collections.map(function (item) {
                        return {
                            title: item.title,
                            img: item.img,
                            hpu: item.request // hpu — параметр для открытия категории
                        };
                    })
                };
                onSuccess(data);
            ...
            // Компонент для коллекции (большие карточки)
            ...
            // Регистрация компонента и манифеста
            var manifest = {
                type: 'video',
                version: '1.0.0',
                name: 'Русское',
            ...
            // Скрытие фона при открытии rus_movie
            ...
            // Кастомная карточка сериалов (с следующим эпизодом)
            ...
            function extendTmdbMain() {
                ...
                Lampa.Api.sources.tmdb.main = function (params, onSuccess, onError) {
                    originalMain(params, function (originalLines) {
                        ...
                        var addedLines = [
                            ...
                            function (success) {
                                ...
                                success({
                                    ...
                                    nomore: true,
                                    cardClass: function (card, next) { return new CustomSeriesCard(card, next); }
                                });
                            },
                            function (success) {
                        ...
                        // Добавляем partPersons и жанры (как в оригинале)
                        try {
                            Lampa.Arrays.insert(addedLines, 0, Lampa.Api.partPersons(addedLines, 6, 'movie', addedLines.length + 1));
                        } catch (e) {}

                        params.genres && params.genres.movie && params.genres.movie.forEach(function (genre) {
            ...
            // Автообновление при смене источника на tmdb
        ...
        // Запуск только если включена настройка
        ...
        if (window.appready) {
            if (Lampa.Storage.get('rus_movie_main') !== false) initPlugin();
        } else {
            ...
            if (listener && typeof listener.follow === 'function') {
                listener.follow('app', function (e) {
                    if (e.type === 'ready' && Lampa.Storage.get('rus_movie_main') !== false) initPlugin();
                });
            } else if (listener && typeof listener.on === 'function') {
                listener.on('ready', function () {
                    if (Lampa.Storage.get('rus_movie_main') !== false) initPlugin();
                });
            } else {
                setTimeout(function () {

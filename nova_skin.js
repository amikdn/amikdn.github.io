(function () {
  ...
  var NOVA_BUILD = "2026-08-18 17:35:33";
  ...
  function ours(list) {
    ...
    for (var i = 0; i < list.length; i++) {
      ...
      try {
        if (!target.closest('.nova-hero,.nova-pills,.nova-seasons,.nova-voices,.nova-actors,.nova-info,.nova-note,.nova-foot')) return false;
      } catch (e) {
        return false;
      }
      mine++;

...
registerSection('add_interface_plugin', 'Интерфейс', icon_add_interface_plugin, [
    { paramName: 'Torrents Styles', fieldName: 'Torrents Styles', description: 'Цветовая индикация торрентов', url: 'https://amikdn.github.io/torrents_styles2.js', pluginName: 'Torrents Styles', author: '@lampa', removeUrl: "https://amikdn.github.io/torrents_styles2.js" },
    { paramName: 'buttons_editor', fieldName: 'Редактор кнопок', description: 'Наводите порядок в кнопках карточки фильма: меняете их порядок, прячете лишние, переименовываете, ставите свои иконки и цвета. Несколько кнопок можно свернуть в папку, а сами кнопки показывать текстом, только иконками или как обычно', url: 'https://amikdn.github.io/buttons.js', pluginName: 'Редактор Кнопок', author: '@amikdn', removeUrl: "https://amikdn.github.io/buttons.js" },
    { paramName: 'card_overlay', fieldName: 'Интерфейс Мод', description: 'Прокачивает карточки: рейтинги TMDB, IMDB, КП и Lampa со значками, качество видео, лейблы Фильм/Сериал, количество сезонов и серий, возрастной ценз и статус сериала цветными. Всё настраивается в отдельном окне', url: 'https://amikdn.github.io/card_overlay.js', pluginName: 'Интерфейс Мод', author: '@amikdn', removeUrl: "https://amikdn.github.io/card_overlay.js" },
	{ paramName: 'nova_skin', fieldName: 'Nova Skin', description: 'Новый интерфейс для плагинов на основе лампаков', url: 'https://amikdn.github.io/nova_skin.js', pluginName: 'Нова Скин', author: '@amikdn', removeUrl: "https://amikdn.github.io/nova_skin.js" },
    { paramName: 'Snow', fieldName: 'Snow', description: 'Падающий Снег', url: 'https://amikdn.github.io/snow.js', pluginName: 'Snow', author: '@lampa', removeUrl: "https://amikdn.github.io/snow.js" },
    { paramName: 'filter_content', fieldName: 'Фильтр контента', description: 'Плагин позволяет фильтровать вывод карточек в приложении через настройки в разделе интерфейс - пункт Фильтр контента', url: 'https://amikdn.github.io/filter_content.js', pluginName: 'Фильтр Контента', author: '@lampa', removeUrl: "https://amikdn.github.io/filter_content.js" },
    { paramName: 'PersonalHub', fieldName: 'PersonalHub', description: 'Плагин добавляет источник Custom, в котором можно сортировать/изменять разделы и карточки на свой вкус', url: 'https://amikdn.github.io/personalhub.js', pluginName: 'PersonalHub', author: '@lampa', removeUrl: "https://amikdn.github.io/personalhub.js" },
    { paramName: 'NoTrailer', fieldName: 'Удаление Трейлеров', description: 'Удаляет пункт Трейлеры', url: 'https://amikdn.github.io/notrailer.js', pluginName: 'Удаление Трейлеров', author: '@lampa', removeUrl: "https://amikdn.github.io/notrailer.js" },
    ...
    { paramName: 'Weather', fieldName: 'Погода', description: 'Плагин будет поочередно показывать время и погоду, чередуя их показания', url: 'https://amikdn.github.io/weather.js', pluginName: 'Погода', author: '@scabrum', removeUrl: "https://amikdn.github.io/weather.js" },
    ...
    { paramName: 'New_source', fieldName: 'Дополнительный источник Кинопоиск (KP)', description: 'Плагин добавляет источник Кинопоиск (KP) для получения информации о фильмах', url: 'https://amikdn.github.io/source.js', pluginName: 'Источник Кинопоиск (KP)', author: '@lampa', removeUrl: "https://amikdn.github.io/source.js" },
    { paramName: 'anti-dmca', fieldName: 'anti-dmca', description: 'Плагин позволяет заходить на заблокированные карточки', url: 'https://amikdn.github.io/anti-dmca.js', pluginName: 'anti-dmca', author: '@lampa', removeUrl: "https://amikdn.github.io/anti-dmca.js" },
    ...
    { paramName: 'Rezka_comments', fieldName: 'Комментарии от Rezka', description: 'Плагин выводит комментарии к фильму от сервиса Rezka', url: 'https://amikdn.github.io/rezkacomment.js', pluginName: 'Комментарии Rezka', author: '@BDV_Burik', removeUrl: "https://amikdn.github.io/rezkacomment.js" },
    ...
    { paramName: 'rus', fieldName: 'Русские новинки', description: 'Плагин добавляет в левом меню пункт с русскими новинками фильмов и сериалов общим списком и отсортированных по онлайн кинотеатрам', url: 'https://amikdn.github.io/rus.js', pluginName: 'Русские Новинки', author: '@lampa', removeUrl: "https://amikdn.github.io/rus.js" },
    { paramName: 'in_qual', fieldName: 'В качестве', description: 'Плагин добавляет в левом меню пункт с фильмами, которые вышли в высоком качестве', url: 'https://amikdn.github.io/quality.js', pluginName: 'В Качестве', author: '@lampa', removeUrl: "https://amikdn.github.io/quality.js" },
    { paramName: 'logo_title', fieldName: 'Лого вместо названия', description: 'Позволяет заменить в карточке название фильма/сериала и т.д. на логотип. В настройках приложения в разделе интерфейс можно откл/вкл показ', url: 'https://amikdn.github.io/logo.js', pluginName: 'Лого Вместо Названия', author: '@lampa', removeUrl: "https://amikdn.github.io/logo.js" },
    ...
    { paramName: 'eng', fieldName: 'Зарубежные подборки', description: 'Плагин добавляет в левом меню пункт с зарубежными подборками', url: 'https://amikdn.github.io/eng.js', pluginName: 'Зарубежные Подборки', author: '@lampa', removeUrl: "https://amikdn.github.io/eng.js" }
]);
...
registerSection('add_management_plugin', 'Управление', icon_add_management_plugin, [
    ...
    { paramName: 'Redirect', fieldName: 'Смена сервера', description: 'Плагин позволяет сменить сервер приложения', url: 'https://amikdn.github.io/redirect.js', pluginName: 'Смена Сервера', author: '@scabrum', removeUrl: "https://amikdn.github.io/redirect.js" },
...
registerSection('add_online_plugin', 'Онлайн', icon_add_online_plugin, [
    ...
    { paramName: 'Онлайн_ONL', fieldName: 'Онлайн ONL', description: 'Плагин для просмотра фильмов и сериалов в онлайн', url: 'https://amikdn.github.io/o.js', pluginName: 'Онлайн ONL', author: '@lampa', removeUrl: "https://amikdn.github.io/o.js" },
	{ paramName: 'Онлайн_LOM', fieldName: 'Онлайн LOM', description: 'Плагин для просмотра фильмов и сериалов в онлайн', url: 'https://amikdn.github.io/onl.js', pluginName: 'Онлайн LOM', author: '@lampa', removeUrl: "https://amikdn.github.io/onl.js" },
	{ paramName: 'Онлайн_AB', fieldName: 'Онлайн AB', description: 'Плагин для просмотра фильмов и сериалов в онлайн', url: 'https://amikdn.github.io/ab.js', pluginName: 'Онлайн AB', author: '@lampa', removeUrl: "https://amikdn.github.io/ab.js" },
	{ paramName: 'BWA', fieldName: 'BWA', description: 'Плагин для просмотра фильмов и сериалов в онлайн', url: 'http://bwa.ad/rc', pluginName: 'Онлайн BWA', author: '@lampa', removeUrl: "http://bwa.ad/rc" },
	{ paramName: 'Alpac', fieldName: 'Alpac', description: 'Плагин для просмотра фильмов и сериалов в онлайн', url: 'https://beta.l-vid.online/on.js', pluginName: 'Alpac', author: '@lampa', removeUrl: "https://beta.l-vid.online/on.js" },
    { paramName: 'Онлайн Filmix', fieldName: 'Онлайн Filmix', description: 'Плагин для просмотра фильмов и сериалов в онлайн', url: 'https://lampaplugins.github.io/store/fx.js', pluginName: 'Онлайн Filmix', author: '@lampa', removeUrl: "https://lampaplugins.github.io/store/fx.js" },
...
registerSection('add_torrent_plugin', 'Торренты', icon_add_torrent_plugin, [
    { paramName: 'Switch_Parser', fieldName: 'Переключение парсеров', description: 'Плагин позволяет переключаться между парсерами jackett из списка с уже забитыми правильными параметрами. В настройках парсера появится пункт со списком общедоступных jacketts', url: 'https://amikdn.github.io/jackett.js', pluginName: 'Переключение Парсеров', author: '@4m1K', removeUrl: "https://amikdn.github.io/jackett.js" },
...
registerSection('add_sisi_plugin', 'Клубничка', icon_add_sisi_plugin, [
    { paramName: 'sisi', fieldName: 'Клубничка (sisi)', description: 'Другая версия плагина Клубничка (у кого не завелся основной плагин)', url: 'http://amikdn.github.io/sisi.js', pluginName: 'Клубничка (sisi)', author: '@lampa', removeUrl: "http://amikdn.github.io/sisi.js" }
]);

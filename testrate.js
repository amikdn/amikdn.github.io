(function () {
    ...
    var DETAIL_STAR_SVG = '<svg viewBox="5 5 54 54" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="none" stroke="currentColor" stroke-width="2" d="M32 18.7461L36.2922 27.4159L46.2682 28.6834L38.9675 35.3631L40.7895 44.8469L32 40.2489L23.2105 44.8469L25.0325 35.3631L17.7318 28.6834L27.7078 27.4159L32 18.7461ZM32 23.2539L29.0241 29.2648L22.2682 30.1231L27.2075 34.6424L25.9567 41.1531L32 37.9918L38.0433 41.1531L36.7925 34.6424L41.7318 30.1231L34.9759 29.2648L32 23.2539Z"/><path fill="none" stroke="currentColor" stroke-width="2" d="M32 9C19.2975 9 9 19.2975 9 32C9 44.7025 19.2975 55 32 55C44.7025 55 55 44.7025 55 32C55 19.2975 44.7025 9 32 9ZM7 32C7 18.1929 18.1929 7 32 7C45.8071 7 57 18.1929 57 32C57 45.8071 45.8071 57 32 57C18.1929 57 7 45.8071 7 32Z"/></svg>';
        ...
        function replaceIcon(className) {
            ...
            scope.find('.full-start-new__rate.' + className + ', .full-start__rate.' + className).each(function () {
                ...
                if (showIcons) {
                    ...
                    if (className === 'rate--lampa') target.text('★');
                }
            });
        }
    ...
    function initPlugin() {
        ...
        style.textContent =
            ...
            '.card-overlay-detail-icon-target{display:inline-flex!important;align-items:center!important;justify-content:center!important;padding:0.1em!important;min-width:1.8em!important;height:1.8em!important;line-height:1!important}' +
            '.card-overlay-detail-icon{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:1.6em!important;height:1.6em!important;overflow:hidden!important;color:currentColor!important}' +
            ...
            '.full-start-new__rate.rate--lampa .card-overlay-lampa-star,.full-start__rate.rate--lampa .card-overlay-lampa-star{font-size:1.1em;line-height:1;padding:0.2em 0.4em}' +

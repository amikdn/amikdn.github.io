(function () {
    ...
    function startPlugin() {
        ...
        var title = $('<div class="player-info__title"></div>');
            ...
            render.find('.player-panel__center').find('.button').not('.player-panel__playpause,.player-panel__prev,.player-panel__next').remove();

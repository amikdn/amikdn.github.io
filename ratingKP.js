(function () {
	...
	// Добавляем в основной раздел "Настройки" (в самый низ списка)
	Lampa.Listener.follow('app', function (e) {
		if (e.type === 'ready') {
			setTimeout(function () {
				...
				// Добавляем в конец основного списка (после всех папок)
				render.find('.settings-folder').last().after(line);

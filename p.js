!function() {
    ...
    function r() {
        var t = $('<li class="menu__item selector" data-action="netflix"><div class="menu__ico">' + e + '</div><div class="menu__text">Netflix</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    window.plugin_podbor_ready || function() {
        function e() {
            window.plugin_podbor_ready || setTimeout((function() {
                "1" == Lampa.Storage.get("porborki_kach") && t(),
                "1" == Lampa.Storage.get("porborki_rus") && c(),
                "1" == Lampa.Storage.get("porborki_okko") && a(),
                "1" == Lampa.Storage.get("porborki_ivi") && o(),
                "1" == Lampa.Storage.get("porborki_wink") && n(),
                "1" == Lampa.Storage.get("porborki_kion") && i(),
                "1" == Lampa.Storage.get("porborki_netflix") && r(),
                "1" == Lampa.Storage.get("porborki_kr") && l(),
                "1" == Lampa.Storage.get("porborki_kp") && p(),
                "1" == Lampa.Storage.get("porborki_mult12") && u(),
                "1" == Lampa.Storage.get("porborki_mult13") && m(),
                "1" != Lampa.Storage.get("porborki_mult14") && "0" == Lampa.Storage.get("porborki_mult14") || v(),
                "1" == Lampa.Storage.get("porborki_mult15") && s(),
                "1" == Lampa.Storage.get("porborki_mult16") && d()
            }
            ), 500),
            ...
            Lampa.SettingsApi.addParam({
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult14", e),
                    1 == e ? 0 == $('[data-action="mult_cub"]').length && v() : $('[data-action="mult_cub"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult12", e),
                    1 == e ? 0 == $('[data-action="mult_tmdb"]').length && u() : $('[data-action="mult_tmdb"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult15", e),
                    1 == e ? 0 == $('[data-action="nickelodeon"]').length && s() : $('[data-action="nickelodeon"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult13", e),
                    1 == e ? 0 == $('[data-action="mult_series"]').length && m() : $('[data-action="mult_series"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_rus", e),
                    1 == e ? 0 == $('[data-action="rus"]').length && c() : $('[data-action="rus"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kach", e),
                    1 == e ? 0 == $('[data-action="hd"]').length && t() : $('[data-action="hd"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_okko", e),
                    1 == e ? 0 == $('[data-action="okko"]').length && a() : $('[data-action="okko"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kp", e),
                    1 == e ? 0 == $('[data-action="kp"]').length && p() : $('[data-action="kp"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_ivi", e),
                    1 == e ? 0 == $('[data-action="ivi"]').length && o() : $('[data-action="ivi"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_wink", e),
                    1 == e ? 0 == $('[data-action="wink"]').length && n() : $('[data-action="wink"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kion", e),
                    1 == e ? 0 == $('[data-action="kion"]').length && i() : $('[data-action="kion"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    ...
                    1 == e ? 0 == $('[data-action="netflix"]').length && r() : $('[data-action="netflix"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kr", e),
                    1 == e ? 0 == $('[data-action="kr"]').length && l() : $('[data-action="kr"]').remove()
                }
            }),
            Lampa.SettingsApi.addParam({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult16", e),
                    1 == e ? 0 == $('[data-action="animes"]').length && d() : $('[data-action="animes"]').remove()
                }
            })
        }

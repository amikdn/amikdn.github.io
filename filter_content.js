(function() {
    ...
    if (window.Lampa && window.Lampa.Manifest) {
        ...
        console.warn('Lampa.Manifest is not available during plugin registration');
    }
    ...
    function _0x5aee9c() {
        ...
        if (window[_0x57722b(0x184)] || !window.Lampa || !window.Lampa.Manifest) {
            console.warn('Skipping _0x5aee9c: lampa_listener_extensions already set or Lampa.Manifest not available');
            return;
        }
        ...
        try {
            Object[_0x57722b(0x1e7)](window['Lampa'][_0x57722b(0x1eb)][_0x57722b(0x1bd)], _0x57722b(0x1ab), {
                ...
                'set': function(_0x57abda) {
                    ...
                    this[_0x12c713(0x21b)] = function() {
                        ...
                        console.log('Calling build with context:', this); // Отладка контекста
                        if (!this || !this[_0x117c88(0x1d3)]) {
                            console.warn('Build context missing params:', this);
                            return; // Пропускаем, если params отсутствует
                        }
                        try {
                            _0x57abda['apply'](this);
                        } catch (e) {
                            console.error('Error in build apply:', e);
                        }
            ...
            console.error('Error in _0x5aee9c:', e);
        }
    }
    ...
    function _0x3d3291() {
        ...
        if (!window.Lampa || !window.Lampa.Lang) {
            console.warn('Lampa.Lang is not available');
            return;
        }
    ...
    function _0x41c505() {
        ...
        if (!window.Lampa || !window.Lampa.SettingsApi || !window.Lampa.Listener) {
            console.warn('Lampa.SettingsApi or Lampa.Listener is not available');
            return;
        }
    ...
    function _0x293ab2() {
        ...
        if (!window.Lampa || !window.Lampa.Storage) {
            console.warn('Lampa.Storage is not available');
            return;
        }
    ...
    function _0x5110e0() {
        ...
        if (window[_0x5cc5ec(0x1ac)] || !window.Lampa || !window.Lampa.Listener) {
            console.warn('Skipping _0x5110e0: lampa_listener_extensions already set or Lampa.Listener not available');
            return;
        }
        ...
        Lampa[_0x5cc5ec(0x1c6)][_0x5cc5ec(0x209)]('request_secuses', function(_0x407b0e) {
            ...
            console.log('Request event:', _0x407b0e); // Отладка
            if (!_0x407b0e || !_0x407b0e['params'] || !_0x407b0e['data'] || !Array[_0xf247e7(0x190)](_0x407b0e[_0xf247e7(0x1b2)]['results'])) {
                console.warn('Skipping request_secuses: invalid event data');
                return;
            }
            console.log('Before filtering:', _0x407b0e[_0xf247e7(0x1b2)]['results']);
            if (_0x58184e(_0x407b0e['params'][_0xf247e7(0x1aa)])) {
                ...
                console.log('After filtering:', _0x407b0e[_0xf247e7(0x1b2)]['results']);
            }
        });
    }

    // Инициализация плагина после полной загрузки Lampa
    if (window.Lampa && window.Lampa.Listener && window.Lampa.Manifest) {
        ...
        // Повторная попытка через setTimeout
        setTimeout(function() {
            if (window.Lampa && window.Lampa.Listener && window.Lampa.Manifest) {
                window[_0x38fdd0(0x22c)] ? _0x5110e0() : Lampa[_0x38fdd0(0x1c6)]['follow']('app', function(_0x20cc63) {
                    var _0x1e06bf = _0x38fdd0;
                ...
                console.warn('Lampa or its components are not available after timeout');
            }

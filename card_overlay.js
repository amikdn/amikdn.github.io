(function () {
    ...
    function initPlugin() {
        ...
        style.textContent =
            ...
            '@media (max-width:480px) and (orientation:portrait){.full-start-new__rate.rate--lampa,.full-start__rate.rate--lampa{min-width:80px}.full-start-new__rate.rate--lampa.lampa-no-icon,.full-start__rate.rate--lampa.lampa-no-icon{min-width:0!important}}' +

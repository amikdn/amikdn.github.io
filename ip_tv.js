...
langAdd('settings_list_url_desc1',
    {
        ...
        en: 'You can add another playlist. Playlist links usually end with <i>.m3u</i> or <i>.m3u8</i>',
...
function configurePlaylist(i) {
    ...
    var defUrl = i === 0 ? 'https://raw.githubusercontent.com/IPTVSHARED/iptv/refs/heads/main/IPTV_SHARED.m3u' : 'http://amikdn.github.io/playlist.m3u8';
    var defTitle = i === 0 ? 'IPTV Shared' : 'Amikdn Playlist';
    var activity = {
        id: i,
        url: '',
        title: plugin.name,
        groups: [],
        currentGroup: getStorage('last_catalog' + i, 'Other'),
        component: plugin.component,
        page: 1
    };
    ...
    addSettings('input', {
        ...
        onChange: function (newVal) {
            var title = !newVal ? defTitle : newVal;
    ...
    addSettings('input', {
        ...
        description: i ? langGet('settings_list_url_desc1') : langGet('settings_list_url_desc0'),
    ...
    var name = getSettings('list_name_' + i) || defTitle;
    var url = getSettings('list_url_' + i) || defUrl;
    var title = name;
    activity.title = title + (title === plugin.name ? '' : ' - ' + plugin.name);

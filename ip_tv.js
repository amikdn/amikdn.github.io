...
function pluginPage(object) {
	...
	Lampa.Template.add(plugin.component + '_info_radio', '<div class="info layer--width"><div class="info__left"><div class="info__title"></div><div class="info__title-original"></div><div class="info__create"></div></div><div class="info__right" style="display: flex !important; justify-content: flex-end; align-items: center; padding-right: 1em;"> <div id="stantion_filtr"></div></div></div>');

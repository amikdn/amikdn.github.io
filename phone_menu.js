...
(function () {
  ...
  var css = [
    ...
    '    max-width: none !important; background: transparent !important; border: none !important;',
    '    box-shadow: none !important; border-radius: 0 !important; margin: 0 8px !important;',
    '    padding: 0 !important; flex: none !important; transform: none !important;',
    '  }',
    '  .head__actions .navigation-bar__item:hover,',
    '  .head__actions .navigation-bar__item.active {',
    '    transform: scale(1.15) !important;',
    '  }',
    '  .head__actions .navigation-bar__icon {',
    '    width: 20px !important; height: 20px !important; margin: 0 !important; padding: 0 !important;',
    '  }',
    '  .head__actions .navigation-bar__icon svg {',
    '    width: 20px !important; height: 20px !important;',
    '  }',
    '  .head__actions .navigation-bar__label { display: none !important; }',
    '}',

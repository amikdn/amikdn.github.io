  ...
  (function() {
    ...
    function init() {
      var EpisodeCard = function(data3) {
        ...
        MyLampaSource = function(baseSource) {
        ...
        myLampaSource = Object.assign({}, Lampa.Api.sources.tmdb, new MyLampaSource(Lampa.Api.sources.tmdb));
      Lampa.Api.sources.mylampa = myLampaSource, Object.defineProperty(Lampa.Api.sources, "mylampa", {
        get: function getSource() {
          return myLampaSource;
        }
      }), Lampa.Params.select("source", Object.assign({}, Lampa.Params.values.source, {
        mylampa: 'MyLampa'
      }), "tmdb");
      if (Lampa.Storage.get("source") == "mylampa") var sourceValue = Lampa.Storage.get("source"),
      ...
      Lampa.Settings.listener.follow('open', function(event3) {
        event3.name == "main" && (Lampa.Settings.main().render().find('[data-component="mylampa_source"]').length == 0 && Lampa.SettingsApi.addComponent({
          component: "mylampa_source",
          name: "Источник MyLampa"
        }), Lampa.Settings.main().update(), Lampa.Settings.main().render().find("[data-component=\"mylampa_source\"]").addClass('hide'));
        ...
        onRender: function(element5) {
          setTimeout(function() {
            $(".settings-param > div:contains(\"Источник MyLampa\")").parent().insertAfter($("div[data-name=\"source\"]")), Lampa.Storage.field('source') !== 'mylampa' ? element5.hide() : element5.show();
          }, 20), element5.on('hover:enter', function() {
            Lampa.Settings.create("mylampa_source"), Lampa.Controller.enabled().controller.back = function() {
        ...
        event.name == "source" && setTimeout(function() {
          Lampa.Storage.get("source") !== "mylampa" ? $('.settings-param > div:contains("Источник MyLampa")').parent().hide() : $(".settings-param > div:contains(\"Источник MyLampa\")").parent().show();
        }, 50);
      });
          ...
          onRender: function(element7) {
            element7.on("hover:enter", function(line) {
              ...
              Lampa.Settings.create(component2), Lampa.Controller.enabled().controller.back = function() {
                Lampa.Settings.create("mylampa_source"), setTimeout(function() {
      ...
      addSetting('now_watch', "Сейчас смотрят", "Нажми для настройки", false, '1', '1', false), addSetting("trend_day", 'Сегодня в тренде', 'Нажми для настройки', false, '1', '3', false), addSetting("trend_day_tv", "Сегодня в тренде (сериалы)", "Нажми для настройки", true, '1', '4', false), addSetting('trend_day_film', 'Сегодня в тренде (фильмы)', "Нажми для настройки", true, '1', '5', false), addSetting('trend_week', "В тренде за неделю", "Нажми для настройки", false, '1', '6', false), addSetting("trend_week_tv", "В тренде за неделю (сериалы)", "Нажми для настройки", true, '1', '7', false), addSetting("trend_week_film", "В тренде за неделю (фильмы)", "Нажми для настройки", true, '1', '8', false), addSetting('upcoming', 'Смотрите в кинозалах', "Нажми для настройки", false, '1', '9', false), addSetting("popular_movie", "Популярные фильмы", "Нажми для настройки", false, '1', '10', false), addSetting("popular_tv", "Популярные сериалы", 'Нажми для настройки', false, '1', '11', false), addSetting("top_movie", "Топ фильмы", "Нажми для настройки", false, '4', '12', false), addSetting("top_tv", "Топ сериалы", "Нажми для настройки", false, '4', '13', false), addSetting("netflix", "Netflix", 'Нажми для настройки', true, '1', '14', false), addSetting("apple_tv", "Apple TV+", "Нажми для настройки", true, '1', '15', false), addSetting("prime_video", "Prime Video", "Нажми для настройки", true, '1', '16', false), addSetting("mgm", "MGM+", "Нажми для настройки", true, '1', '17', false), addSetting("hbo", "HBO", "Нажми для настройки", true, '1', '18', false), addSetting("dorams", "Дорамы", 'Нажми для настройки', true, '1', '19', false), addSetting("tur_serials", 'Турецкие сериалы', "Нажми для настройки", true, '1', '20', false), addSetting("ind_films", "Индийские фильмы", "Нажми для настройки", true, '1', '21', false), addSetting("rus_movie", "Русские фильмы", "Нажми для настройки", true, '1', '22', false), addSetting("rus_tv", "Русские сериалы", "Нажми для настройки", true, '1', '23', false), addSetting("rus_mult", "Русские мультфильмы", 'Нажми для настройки', true, '1', '24', false), addSetting('start', "Start", "Нажми для настройки", true, '1', '25', false), addSetting("premier", "Premier", "Нажми для настройки", true, '1', '26', false), addSetting("kion", "KION", "Нажми для настройки", true, '1', '27', false), addSetting("ivi", "ИВИ", 'Нажми для настройки', true, '1', '28', false), addSetting("okko", "Okko", "Нажми для настройки", true, '1', '29', false), addSetting("kinopoisk", "КиноПоиск", "Нажми для настройки", true, '1', '30', false), addSetting('wink', 'Wink', "Нажми для настройки", true, '1', '31', false), addSetting('sts', 'СТС', "Нажми для настройки", true, '1', '32', false), addSetting("tnt", "ТНТ", "Нажми для настройки", true, '1', '33', false), addSetting('collections_inter_tv', 'Подборки зарубежных сериалов', "Нажми для настройки", true, '1', '34', false), addSetting('collections_rus_tv', "Подборки русских сериалов", 'Нажми для настройки', true, '1', '35', false), addSetting("collections_inter_movie", 'Подборки зарубежных фильмов', "Нажми для настройки", true, '1', '36', false), addSetting("collections_rus_movie", 'Подборки русских фильмов', "Нажми для настройки", true, '1', '37', false), Lampa.SettingsApi.addParam({
        component: "mylampa_source",
        param: {
      ...
      var bootInterval = setInterval(function() {
        if (typeof Lampa !== "undefined") {
          ...
          if (!Lampa.Storage.get('mylampa_source_params', "false")) initDefaults();
        }
      }, 200);

      function initDefaults() {
        Lampa.Storage.set("mylampa_source_params", "true"), Lampa.Storage.set("trend_day_tv_remove", "true"), Lampa.Storage.set("trend_day_film_remove", "true"), Lampa.Storage.set("trend_week_tv_remove", "true"), Lampa.Storage.set("trend_week_film_remove", "true"), Lampa.Storage.set("top_movie_display", '4'), Lampa.Storage.set("top_tv_display", '4'), Lampa.Storage.set("netflix_remove", 'true'), Lampa.Storage.set("apple_tv_remove", 'true'), Lampa.Storage.set('prime_video_remove', "true"), Lampa.Storage.set("mgm_remove", "true"), Lampa.Storage.set('hbo_remove', "true"), Lampa.Storage.set("dorams_remove", "true"), Lampa.Storage.set("tur_serials_remove", "true"), Lampa.Storage.set("ind_films_remove", "true"), Lampa.Storage.set("rus_movie_remove", "true"), Lampa.Storage.set('rus_tv_remove', "true"), Lampa.Storage.set("rus_mult_remove", "true"), Lampa.Storage.set("start_remove", "true"), Lampa.Storage.set("premier_remove", "true"), Lampa.Storage.set("kion_remove", "true"), Lampa.Storage.set('ivi_remove', 'true'), Lampa.Storage.set("okko_remove", "true"), Lampa.Storage.set("kinopoisk_remove", "true"), Lampa.Storage.set("wink_remove", "true"), Lampa.Storage.set("sts_remove", "true"), Lampa.Storage.set("tnt_remove", "true"), Lampa.Storage.set("collections_inter_tv_remove", "true"), Lampa.Storage.set("collections_rus_tv_remove", "true"), Lampa.Storage.set("collections_inter_movie_remove", "true"), Lampa.Storage.set("collections_rus_movie_remove", "true"), Lampa.Storage.set("genres_cat", "true");
      }
    }

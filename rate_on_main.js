(function() {
    ...
    // Анти-дебаг код из плагина качества
    (function() {
    ...
    function addQualityToCard(cardElement, quality) {
        ...
        if (!qualityId) {
            qualityId = 'card_' + (Date.now() % 10000);
    ...
    // Обработка карточки для качества
    ...
    Lampa.Listener.follow('full', function(e) {
        if (e.type === 'complite') {
            ...
            addQualityToFull(e); // Добавление качества в полную страницу
        }
    });

(function() {
  ...
  // Опционально – реализация BlazorNet, если требуется (обычно используется Lampa.Reguest)
  function BlazorNet() {
  ...
  // Для использования BlazorNet можно раскомментировать следующую строку:
  // var Network = Defined.api.indexOf('pwa') === 0 && typeof Blazor !== 'undefined' ? BlazorNet : Lampa.Reguest;

  // =======================================================================
  // Функция account() — подставляет фиксированные параметры uid, token и ab_token
  ...
  function component(object) {
    ...
    this.similars = function(json) {
      ...
      json.forEach(function(elem) {
        ...
        var item = Lampa.Template.get('lampac_prestige_folder', elem, true);
    ...
    this.draw = function(items) {
      ...
      this.getEpisodes(items[0].season, function(episodes) {
        ...
        items.forEach(function(element, index) {
          ...
          var html = Lampa.Template.get('lampac_prestige_full', element, true);
    ...
    this.empty = function() {
      var html = Lampa.Template.get('lampac_does_not_answer', {}, true);
    ...
    this.doesNotAnswer = function(er) {
      var _this9 = this;
      this.reset();
      var html = Lampa.Template.get('lampac_does_not_answer', { balanser: balanser }, true);
      if (er && er.accsdb)

(function() {
  ...
  // Функция для расшифровки строки, закодированной в Base64
  ...
  var URL_INVC_RCH   = decodeLink("aHR0cHM6Ly9hYm1zeC50ZWNoL2ludmMtcmNoLmpz"); // https://abmsx.tech/invc-rch.js
  ...
  // Подключаем скрипт rch с зашифрованным URL
  if (!window.rch) {
  ...
  function component(object) {
    ...
    this.rch = function(json, noreset) {
      ...
      if (typeof signalR == 'undefined') {
        Lampa.Utils.putScript([URL_SIGNALR], function() {}, false, function() {
          load();
        }, true);
      } else load();
    };
      ...
      return new Promise(function(resolve, reject) {
        ...
        network.silent(account(url), function(json) {
          ...
          if (json.life) {
            ...
            filter.render().find('.filter--sort').append('<span class="lampac-balanser-loader" style="width: 1.2em; height: 1.2em; margin-top: 0; background: url(' + URL_IMG_LOADER + ') no-repeat 50% 50%; background-size: contain; margin-left: 0.5em"></span>');

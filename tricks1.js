(function() {
  ...
  // При необходимости можно раскомментировать вариант с BlazorNet:
  ...
  function component(object) {
    ...
    var last;
    var source;
    var balanser; // выбранный балансер
    var initialized;
    var balanser_timer;
    var images = [];
    ...
    // =========================================================================
    // Исправленная функция requestParams – она проверяет выбран ли балансер "filmixtv" и при необходимости подменяет URL:
  ...
  function startPlugin() {
    ...
    function resetTemplates() {
      ...
      // Добавьте остальные шаблоны по необходимости
    }
    // Добавление кнопок, обработчиков и прочего – без изменений.
  }

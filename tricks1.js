...
// === ПЕРЕХВАТ ОТВЕТА ОТ СЕРВЕРА (обернут в try/catch) === try { var originalSilent = Lampa.Reguest.prototype.silent; Lampa.Reguest.prototype.silent = function(url, success, error, post, params) { var newSuccess = function(response) { // Если ответ приходит в виде строки и содержит индикатор "accsdb" if (typeof response === 'string' && response.indexOf('"accsdb":') !== -1) { // Здесь задаём HTML-ответ, который должен возвращаться вместо минимального ответа. // Обратите внимание – данный HTML можно генерировать динамически в зависимости от URL или выбранного фильма. var desiredResponse = '<div class="videos__line">' + '<div class="videos__item videos__movie selector focused" media="" data-json='{"method":"play","url":"https://nl105.cdnsqu.com/s/FH0RWWlZgmkG66bFD86cFmJEFBQUFBTmZQT1VFUmtnVWxRUUcxdzNBaw.IskRh6mVjp1HcXw428DdHM2ZHC6E9Sc_QcP1hQ/UHD_1212/The.Gorge.2025.D.ru.RedHeadSound.4K.SDR.WEBDL.4t.2160pp_2160.mp4","quality":{"2160p":"https://nl105.cdnsqu.com/s/FH0RWWlZgmkG66bFD86cFmJEFBQUFBTmZQT1VFUmtnVWxRUUcxdzNBaw.IskRh6mVjp1HcXw428DdHM2ZHC6E9Sc_QcP1hQ/UHD_1212/The.Gorge.2025.D.ru.RedHeadSound.4K.SDR.WEBDL.4t.2160pp_2160.mp4","1440p":"https://nl105.cdnsqu.com/s/FH0RWWlZgmkG66bFD86cFmJEFBQUFBTmZQT1VFUmtnVWxRUUcxdzNBaw.IskRh6mVjp1HcXw428DdHM2ZHC6E9Sc_QcP1hQ/UHD_1212/The.Gorge.2025.D.ru.RedHeadSound.4K.SDR.WEBDL.4t.2160pp_1440.mp4","1080p":"https://nl105.cdnsqu.com/s/FH0RWWlZgmkG66bFD86cFmJEFBQUFBTmZQT1VFUmtnVWxRUUcxdzNBaw.IskRh6mVjp1HcXw428DdHM2ZHC6E9Sc_QcP1hQ/UHD_1212/The.Gorge.2025.D.ru.RedHeadSound.4K.SDR.WEBDL.4t.2160pp_1080.mp4","720p":"https://nl105.cdnsqu.com/s/FH0RWWlZgmkG66bFD86cFmJEFBQUFBTmZQT1VFUmtnVWxRUUcxdzNBaw.IskRh6mVjp1HcXw428DdHM2ZHC6E9Sc_QcP1hQ/UHD_1212/The.Gorge.2025.D.ru.RedHeadSound.4K.SDR.WEBDL.4t.2160pp_720.mp4","480p":"https://nl105.cdnsqu.com/s/FH0RWWlZgmkG66bFD86cFmJEFBQUFBTmZQT1VFUmtnVWxRUUcxdzNBaw.IskRh6mVjp1HcXw428DdHM2ZHC6E9Sc_QcP1hQ/UHD_1212/The.Gorge.2025.D.ru.RedHeadSound.4K.SDR.WEBDL.4t.2160pp_480.mp4"},"translate":"\\u0414\\u0443\\u0431\\u043B\\u044F\\u0436 [Rus, Red Head Sound]","maxquality":"2160p","title":"\u0423\u0449\u0435\u043B\u044C\u0435 (\u0414\u0443\u0431\u043B\u044F\u0436 [Rus, Red Head Sound])"}'>' + '</div>'; success(desiredResponse); } else { success(response); } }; return originalSilent.call(this, url, newSuccess, error, post, params); }; } catch(e) { console.error("Ошибка в переопределении метода silent:", e); } // === КОНЕЦ ПЕРЕХВАТА ===

var Defined = { api: 'lampac', localhost: 'https://akter-black.com/', apn: '' };

var unic_id = Lampa.Storage.get('lampac_unic_id', ''); if (!unic_id) { unic_id = Lampa.Utils.uid(8).toLowerCase(); Lampa.Storage.set('lampac_unic_id', unic_id); }
...
function account(url) {
  ...
  // Фиксированный token оставляем пустым, как требуется
  var fixedToken = "";

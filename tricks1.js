(function() {
  ...
  // Если объект Lampa.Template не определён – создаём его (это поможет избежать ошибки "Template [lampac_css] not found")
  ...
  // =======================================================================
  // Функция account() с фиксированными значениями uid и token
  function account(url) {
    ...
    // Подставляем фиксированные token и ab_token

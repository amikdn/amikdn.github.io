(function(){
  ...
  // Функция для добавления кнопок перезагрузки и выхода в шапку приложения
  function addHeaderButtons(){
    try {
      ...
      // Кнопка выхода (EXIT) – квадрат с крестиком, цвета через currentColor
      ...
      // Добавляем кнопки в шапку приложения
  ...
  function add(){
    ...
    // 9. Добавить кнопку перезагрузки и кнопки выхода (управляем через параметр Reloadbutton)
    Lampa.SettingsApi.addParam({
      component: 'Multi_Menu_Component',
    ...
    // 12. Стилизация встроенного плеера – YouTubeStyle
    Lampa.SettingsApi.addParam({
      component: 'Multi_Menu_Component',
    ...
    // Создание кнопок для разделов в главном меню
    var TubeSVG = '<svg width="256px" height="256px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff">' +
          '<path d="M45.1,12.8a5.5,5.5,0,0,0-3.9-3.9C37.8,8,24,8,24,8S10.2,8,6.8,8.9a5.5,5.5,0,0,0-3.9,3.9C2,16.2,2,23.4,2,23.4 s0,7.2.9,10.6a5.5,5.5,0,0,0,3.9,3.9c3.4.9,17.2.9,17.2.9s13.8,0,17.2-.9A5.5,5.5,0,0,0,45.1,34c.9-3.4.9-10.6.9-10.6S46,16.2,45.1,12.8Z"/>' +
    ...
    // Функция обновления отображения кнопок просмотра для торрентов (при BUTTONS_fix)
    function updateT(){
      if(Lampa.Storage.field('BUTTONS_fix') === true){
    ...
    // Создание кнопок для разделов в главном меню (повторное создание)
    var TubeSVG = '<svg width="256px" height="256px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff">' +
          '<path d="M45.1,12.8a5.5,5.5,0,0,0-3.9-3.9C37.8,8,24,8,24,8S10.2,8,6.8,8.9a5.5,5.5,0,0,0-3.9,3.9C2,16.2,2,23.4,2,23.4 s0,7.2.9,10.6a5.5,5.5,0,0,0,3.9,3.9c3.4.9,17.2.9,17.2.9s13.8,0,17.2-.9A5.5,5.5,0,0,0,45.1,34c.9-3.4.9-10.6.9-10.6S46,16.2,45.1,12.8Z"/>' +
          '<path d="M19.6,30V16.8L31,23.4Z"/>' +
        '</svg>';

/**
 * Applecation (Apple TV стиль для Lampa)
 * Версия: 1.1.2
 * Плагин оформления карточки фильма/сериала в стиле Apple TV.
 */
!function() {
    "use strict";
    const n = "1.1.2"; // version

    function e(n) {
        return n && !n.__destroyed; // isActivityAlive
    }

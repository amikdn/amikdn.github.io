 function () {
    ...
    function t() {
        console.log('Applecation', 'v1.1.2');
        Lampa.Platform.screen('tv') ? (function () {
            const n = Lampa.Api.sources.tmdb, e = Lampa.Template.js;
            Lampa.Template.js = function (n, t) {
                if ('full_episode' === n && t && (t.runtime > 0 ? t.time = Lampa.Utils.secondsToTimeHuman(60 * t.runtime).replace(/\./g, '') : t.time = '', t.air_date)) {
                    const n = new Date(t.air_date.replace(/-/g, '/')), e = n.getMonth() + 1, a = Lampa.Lang.translate('month_' + e + '_e'), o = i('year_short');
            ...
            const t = n.img;
            n.img = function (e, a) {
                const i = Lampa.Storage.field('poster_size'), o = Lampa.Storage.get('applecation_poster_quality', 'medium'), r = 'string' == typeof a && -1 !== a.indexOf('_face'), l = [
                        'w92',
                        'w154',
                        'w185',
                        'w342',
                ...
                let p = false;
                return l && ('low' === o ? (a = r ? 'w276_and_h350_face' : 'w300', p = true) : 'medium' === o ? (a = r ? 'w600_and_h900_face' : 'w780', p = true) : 'high' === o && (a = 'original', p = true)), s && ('low' === o || 'medium' === o ? (a = 'w1280', p = true) : 'high' === o && (a = 'original', p = true)), p || 'w1280' !== a || (a = {
                    w200: 'w780',
                    w300: 'w1280',
                    w500: 'original'
                }[i] || 'w1280'), p || 'w300' !== a || (a = {
            ...
            field: { name: i('settings_title_display') }
            ...
            field: { name: i('settings_title_scaling') }
        }), Lampa.SettingsApi.addParam({
            component: 'applecation_settings',
            param: {
                ...
                try {
                    ...
                    n.on('hover:enter', function () {
                        !function () {
                            ...
                            var n = $(Lampa.Template.get('applecation_tvigl_modal', {}, true));
                            $('body').append(n);
                            var e = n.find('.js-go'), t = n.find('.js-close');
        ...
        }), Lampa.Storage.get('applecation_show_ratings', false) || $('body').addClass('applecation--hide-ratings'), $('body').addClass('applecation--ratings-' + Lampa.Storage.get('applecation_ratings_position', 'card')), o(), Lampa.Listener.follow('full', n => {
            if (Lampa.Storage.get('applecation_description_overlay', true) && function (n) {
                    if ('start' === n.type && n.link) {
                        const e = n.link.rows, t = e.indexOf('description');
                        t > -1 && e.splice(t, 1);
                    }
                }(n), 'complite' === n.type) {
                const a = n.object.activity, i = a.render();
                ...
                (function (n) {
                    const t = n.data.movie, a = n.object.activity;
                    if (!t || !a) {
                        return;
                    }
                    (function (n, e) {
                        const t = n.render().find('.applecation__meta-text'), a = [];
                        if (a.push(function (n) {
                                const e = Lampa.Storage.get('language', 'ru'), t = !!n.name, a = {
                                        ru: t ? 'Сериал' : 'Фильм',
                    ...
                    (function (n, e) {
                        const t = n.render().find('.applecation__description'), a = n.render().find('.applecation__description-wrapper'), i = e.overview || '', o = Lampa.Storage.get('applecation_description_overlay', true);
                        t.text(i);
                        o ? (function (n, e) {
                            const t = e.overview || '', a = e.title || e.name;
                            if (!t) {
                                return;
                            }
                            $('.applecation-description-overlay').remove();
                            const i = (e.release_date || e.first_air_date || '') + '', o = i.length > 3 ? Lampa.Utils.parseTime(i).full : i.length > 0 ? i : Lampa.Lang.translate('player_unknown'), r = '$ ' + Lampa.Utils.numberWithSpaces(e.budget || 0), l = function (n) {
                                    return n.production_countries ? n.production_countries.map(n => {
                                        const e = 'country_' + n.iso_3166_1.toLowerCase(), t = Lampa.Lang.translate(e);
                                        return t !== e ? t : n.name;
                                    }) : [];
                                }(e), s = l.join(', '), p = $(Lampa.Template.get('applecation_overlay', {
                                    title: a,
                                    text: t,
                                    relise: o,
                                    budget: r,
                            ...
                            $('body').append(p);
                            p.data('controller-created', false);
                            ...
                            !function () {
                                ...
                                if (n.length) {
                                    if (setTimeout(() => n.addClass('show'), 10), !n.data('controller-created')) {
                                        ...
                                        n.data('controller-created', true);
                                    }
                    ...
                    (function (n, e) {
                        const t = n.render().find('.applecation__info'), a = [], i = e.release_date || e.first_air_date || '';
                        if (i) {
                            const n = i.split('-')[0];
                            a.push(n);
                        }
                        if (e.name) {
                            if (e.episode_run_time && e.episode_run_time.length) {
                                const n = e.episode_run_time[0], t = Lampa.Lang.translate('time_m').replace('.', '');
                                a.push(`${ n } ${ t }`);
                            }
                            ...
                            n && a.push(function (n) {
                                ...
                                if ('en' === e) {
                                    return 1 === n ? `${ n } Season` : `${ n } Seasons`;
                                }
                                if ('cs' === e) {
                                    return 1 === n || n >= 2 && n <= 4 ? `${ n } série` : `${ n } sérií`;
                                }
                                if ('pt' === e) {
                                    return 1 === n ? `${ n } Temporada` : `${ n } Temporadas`;
                                }
                                if ('he' === e) {
                                    return 1 === n ? `עונה ${ n }` : `${ n } עונות`;
                                }
                                if ('zh' === e) {
                                    return `${ n } 季`;
                                }
                            ...
                            if (e.runtime && e.runtime > 0) {
                                const n = Math.floor(e.runtime / 60), t = e.runtime % 60, i = Lampa.Lang.translate('time_h').replace('.', ''), o = Lampa.Lang.translate('time_m').replace('.', ''), r = n > 0 ? `${ n } ${ i } ${ t } ${ o }` : `${ t } ${ o }`;
                                a.push(r);
                            }
                        }
                        const o = a.length > 0 ? a.join(' \xB7 ') : '';
                    ...
                    s(a, () => {
                        ...
                        const n = Lampa.Storage.get('applecation_description_overlay', true), t = a.render().find('.applecation__description-wrapper').addClass('show');
                        n && (t.addClass('selector'), window.Lampa && Lampa.Controller && Lampa.Controller.collectionAppend(t));
                        a.render().find('.applecation__info').addClass('show');
                        a.render().find('.applecation__ratings').addClass('show');
                    });
                    const i = t.name ? 'tv' : 'movie', o = Lampa.TMDB.api(`${ i }/${ t.id }/images?api_key=${ Lampa.TMDB.key() }&language=${ Lampa.Storage.get('language') }`);
                    $.get(o, n => {
                        if (!e(a)) {
                            return;
                        }
                        const t = a.render().find('.applecation__logo'), i = a.render().find('.full-start-new__title');
                        if (n.logos && n.logos[0]) {
                            const i = n.logos[0].file_path, o = function () {
                                ...
                                }(), r = Lampa.TMDB.image(`/t/p/${ o }${ i }`), l = new Image();
                            l.onload = () => {
                ...
                (function (n) {
                    const e = n.render().find('.full-start__background:not(.applecation__overlay)')[0], t = n.render().find('.scroll__body')[0];
                    if (!e || !t) {
                        return;
                    }
                    let a = false;
                    ...
                    Object.defineProperty(t.style, '-webkit-transform', {
                        set: function (n) {
                            if (n) {
                                const t = n.indexOf(',') + 1, i = n.indexOf(',', t);
                                if (t > 0 && i > t) {
                ...
                (function (n) {
                    ...
                    setTimeout(() => {
                        e(n) && t.each(function () {
                            const n = $(this), e = n.text().trim();
                            if (e) {
                                if (function (n) {
                                        return n.scrollWidth > n.clientWidth + 1;
                                    }(n[0])) {
                                    const t = Math.min(Math.max(0.25 * e.length, 5), 20);
                                    n.addClass('marquee-processed marquee-active');
                                    n.css('--marquee-duration', t + 's');
                                    const a = $('<span>').text(e), i = $('<span>').text(e), o = $('<div class="marquee__inner">').append(a).append(i);
                                    n.empty().append(o);
                                } else {
                ...
                const r = n.data, l = r && r.movie;
                l && function (n, t) {
                    if (!n || !Lampa.Storage.field('parser_use')) {
                        return;
                    }
                    if (!Lampa.Parser || 'function' != typeof Lampa.Parser.get) {
                        return;
                    }
                    const a = n.title || n.name || 'Неизвестно', i = ((n.first_air_date || n.release_date || '0000') + '').slice(0, 4), o = {
                            df: n.original_title,
                    ...
                    Lampa.Parser.get({
                        ...
                        if (!n || !n.Results || 0 === n.Results.length) {
                            return;
                        }
                        const i = {
                            resolutions: new Set(),
                        ...
                        n.Results.forEach(n => {
                            if (n.ffprobe && Array.isArray(n.ffprobe)) {
                                const e = function (n) {
                                    ...
                                    if (t) {
                                        if (t.width && t.height && (null = `${ t.width }x${ t.height }`, t.height >= 2160 || t.width >= 3840 ? e.resolutionLabel = '4K' : t.height >= 1440 || t.width >= 2560 ? e.resolutionLabel = '2K' : t.height >= 1080 || t.width >= 1920 ? e.resolutionLabel = 'FULL HD' : (t.height >= 720 || t.width >= 1280) && (e.resolutionLabel = 'HD')), t.side_data_list) {
                                            const n = t.side_data_list.some(n => 'Mastering display metadata' === n.side_data_type), a = t.side_data_list.some(n => 'Content light level metadata' === n.side_data_type);
                                            t.side_data_list.some(n => 'DOVI configuration record' === n.side_data_type || 'Dolby Vision RPU' === n.side_data_type) ? (false = true, false = true) : (n || a) && (false = true);
                                        }
                                        true && t.color_transfer && [
                                            'smpte2084',
                                            'arib-std-b67'
                                        ].includes(t.color_transfer.toLowerCase()) && (false = true);
                                        true && t.codec_name && (t.codec_name.toLowerCase().includes('dovi') || t.codec_name.toLowerCase().includes('dolby')) && (false = true, false = true);
                                    }
                                    const a = n.filter(n => 'audio' === n.codec_type);
                                    let i = 0;
                                    return a.forEach(n => {
                                        n.channels && n.channels > i && (i = n.channels);
                                    }), i >= 8 ? null = '7.1' : i >= 6 ? null = '5.1' : i >= 4 ? null = '4.0' : i >= 2 && (null = '2.0'), e;
                                }(n.ffprobe);
                                e && (e.resolutionLabel && i.resolutions.add(e.resolutionLabel), e.audio && i.audio.add(e.audio));
                                i.hasDub || n.ffprobe.filter(n => 'audio' === n.codec_type && n.tags).forEach(n => {
                                    const e = (n.tags.language || '').toLowerCase(), t = (n.tags.title || n.tags.handler_name || '').toLowerCase();
                                    'rus' !== e && 'ru' !== e && 'russian' !== e || (t.includes('dub') || t.includes('дубляж') || t.includes('дублир') || 'd' === t) && (i.hasDub = true);
                                });
                            }
                            const e = n.Title.toLowerCase();
                            (e.includes('dolby vision') || e.includes('dovi') || e.match(/\bdv\b/)) && i.hdr.add('Dolby Vision');
                            e.includes('hdr10+') && i.hdr.add('HDR10+');
                            e.includes('hdr10') && i.hdr.add('HDR10');
                            e.includes('hdr') && i.hdr.add('HDR');
                        });
                        const o = {
                            title: a,
                        ...
                        if (i.hdr.has('Dolby Vision') && (o.dv = true, o.hdr = true), i.hdr.size > 0) {
                            o.hdr = true;
                            const n = [
                                'HDR10+',
                                'HDR10',
                        ...
                        t && void 0 === t.applecation_quality && (t.applecation_quality = o, function (n, e) {
                            ...
                            a.length > 0 && (t.html(a.join('')), t.addClass('show'));
                        }(t, o));
                    }, n => {
                        console.log('Applecation', { error: n });
                    });
                }(l, a);
            }
        }), function () {
            try {
                if (window.applecation_episodes_core_patch) {
                    return;
                }
                if (window.applecation_episodes_core_patch = true, window.episodes_order_fix = true, window.episodes_core_patch = true, !window.Lampa || !Lampa.Utils || 'function' != typeof Lampa.Utils.createInstance) {
                    return;
                }
                if (Lampa.Utils.__applecation_episodes_core_patch_applied) {
                    return;
                }
                function e(n) {
                    try {
                        ...
                        if (!Array.isArray(n.results) || !n.results.length) {
                            return false;
                        }
                ...
                function a(n) {
                    try {
                        if (!n || !n.scroll || 'function' != typeof n.scroll.append) {
                            return;
                        }
                        if (n.__applecation_episodes_scroll_append_patched) {
                            return;
                        }
                        n.__applecation_episodes_scroll_append_patched = true;
                        var e = n.scroll.append.bind(n.scroll);
                        n.scroll.append = function (t) {
                            var a = t instanceof jQuery ? t[0] : t;
                            if (a && a.classList && a.classList.contains('card-more')) {
                                return e(t);
                            }
                            var i = 'function' == typeof n.scroll.body ? n.scroll.body(true) : null;
                            if (i) {
                                var o = i.querySelector('.card-more');
                                if (o && a && a !== o) {
                                    return void i.insertBefore(a, o);
                                }
                            }
                            return e(t);
                        };
                ...
                function i(n) {
                    try {
                        if (!n || 'function' != typeof n.create) {
                            return;
                        }
                        if (n.__applecation_episodes_create_patched) {
                            return;
                        }
                        n.__applecation_episodes_create_patched = true;
                        ...
                        n.create = function () {
                            ...
                            return setTimeout(function () {
                                try {
                                    var e = n && n.scroll && 'function' == typeof n.scroll.body ? n.scroll.body(true) : null, t = e ? e.querySelector('.card-more') : null;
                ...
                Lampa.Utils.createInstance = function (a, o, r, l) {
                    var s = e(o), p = Lampa.Storage.get('applecation_reverse_episodes', true);
                    s && p && t(o);
    ...
    function o() {
        const n = parseInt(Lampa.Storage.get('applecation_logo_scale', '100')), e = parseInt(Lampa.Storage.get('applecation_text_scale', '100')), t = parseInt(Lampa.Storage.get('applecation_spacing_scale', '100'));
    ...
    function s(n, t) {
        ...
        if (a.hasClass('loaded') && a.hasClass('applecation-animated')) {
            return void t();
        }
        ...
        setTimeout(() => {
            clearInterval(i);
            a.hasClass('applecation-animated') || (a.addClass('applecation-animated'), t());
        }, 2000);
    }
    var p = {
        type: 'other',
    ...
    Lampa.Manifest && Lampa.Manifest.plugins && (Lampa.Manifest.plugins = p);
    window.appready ? t() : Lampa.Listener.follow('app', n => {
        'ready' === n.type && t();
    });
}();
